  ...
  return (
    <Section variant="white">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
        ...
        >
          <h2 className="text-3xl font-bold mb-2">Next JavaScript meetups in Zurich</h2>
          <p className="mb-4">
            Get ready to geek out at our epic JS meetups! Knowledge sharing, networking & pure
            coding fun!
          </p>
        </motion.div>
        <motion.div
        ...
        >
          <Button href="/events" variant="outline" className="border-blue-700 text-blue-700">
            View All Events
          </Button>
        </motion.div>
      </div>
