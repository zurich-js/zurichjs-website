      ...
      try {
        ...
        if (response.ok) {
          ...
          try {
            ...
            console.log(
              "Referrer metadata API response in profile page:",
        ...
        <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Pre-filled email and details for quicker registration
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-gradient-to-br from-purple-100 to-indigo-100 rounded-xl shadow-md p-6 flex flex-col h-full">
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Gain insights from industry experts with specialized deep-dive sessions and
                  networking.
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-yellow-100 to-amber-100 rounded-xl shadow-md p-6 flex flex-col h-full">
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Hands-on learning experiences to level up your JavaScript skills with industry
                  leaders.
                </p>
              </div>
              <div className="mt-auto">
          ...
          <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl shadow-lg p-8 mb-8 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
              <div className="text-left mb-4 md:mb-0">
                ...
                <p className="text-gray-700">
                  Join our Slack workspace to engage directly with speakers, participate in polls,
                  ask questions, and help shape the future of ZurichJS. It&apos;s where our
          ...
          <div className="bg-gradient-to-r from-green-100 to-teal-100 rounded-xl shadow-lg p-8 mb-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-700 mb-6">
                Invite friends to ZurichJS and earn credits! For each successful referral,
                you&apos;ll receive credits that can be exchanged for workshop discounts, event
              ...
              <div className="bg-white bg-opacity-90 rounded-lg p-4 mb-6">
                ...
                {showCreditsInfo && (
                  <div className="mt-3 text-sm text-gray-600 bg-teal-50 p-3 rounded-lg">
                    <div className="mb-2">
                      Credits are awarded based on purchases made by your referrals:
                    </div>
                    <ul className="list-disc pl-5 space-y-1 mb-2">
                      <li>
                        Referral Signup: <span className="font-medium">5 credits</span>
                      </li>
                      <li>
                        T-shirt Purchase (25 CHF): <span className="font-medium">25 credits</span>
                      </li>
                      <li>
                        Workshop Ticket: <span className="font-medium">1:1 with price in CHF</span>
                      </li>
                      <li>
                        All Purchases: <span className="font-medium">1 CHF = 1 credit</span>
                      </li>
                    </ul>
                    <div>
                      Credits may take up to 48 hours to be added to your account. For any issues,
                      please contact{" "}
                      <a href="mailto:hello@zurichjs.com" className="text-teal-700 underline">
                        hello@zurichjs.com
                      </a>
                      .
                    </div>
              ...
              {isValid ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-900">
                      {surveyData?.newsletter ? "Subscribed" : "Not subscribed"}
                    </p>
                  </div>
                  <div className="mt-6">
                    <Button href="/profile/survey" variant="outline" className="w-full">
                ...
                <div className="space-y-6">
                  <p className="text-gray-700">
                    Complete your profile to unlock all ZurichJS benefits including personalized
                    event recommendations and automatic 20% discount on all paid events!
                  </p>
                  <Button
                    href="/profile/survey"
                    variant="primary"
