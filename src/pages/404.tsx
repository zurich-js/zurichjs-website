      ...
      <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-js to-js-dark text-gray-900 font-mono p-4 pt-24">
        <main className="flex flex-col items-center justify-center max-w-3xl">
            ...
            <div className="bg-gray-950 p-4 text-sm text-gray-200">
              <div className="flex mb-1">
                ...
                <span className="text-red-400 font-bold">
                  {isClient ? randomError : "Error: Page not found"}
                </span>
              </div>
              <div className="flex mb-1">
                <span className="text-gray-500 w-8 text-right mr-4">2</span>
                <span>
                  at <span className="text-blue-400">findPage</span>(
                  <span className="text-green-400">app.js:404:42</span>)
                </span>
              </div>
              <div className="flex mb-1">
                <span className="text-gray-500 w-8 text-right mr-4">3</span>
                <span>
                  at <span className="text-blue-400">renderRoute</span>(
                  <span className="text-green-400">router.js:42:11</span>)
                </span>
              </div>
              <div className="flex mb-1">
                <span className="text-gray-500 w-8 text-right mr-4">4</span>
                <span>
                  at <span className="text-blue-400">Promise.then.catch</span>(
                  <span className="text-green-400">async:63:13</span>)
                </span>
              </div>
              <div className="flex mb-1">
              ...
              <div className="flex mb-1">
                ...
                <span>
                  ...
                  <span className="text-green-400">&quot;Go back to homepage&quot;</span>;
                </span>
              </div>
              <div className="flex mb-1">
                ...
                <span>
                  <span className="text-purple-400">const</span>{" "}
                  <span className="text-yellow-300">attemptedPath</span> ={" "}
                  <span className="text-green-400">
                    &quot;{isClient ? router.asPath : "/404"}&quot;
                  </span>
                  ;
                </span>
              </div>
          ...
          <p className="text-xl mb-6 text-center text-black">
            ...
            <span className="bg-gray-900 px-2 py-1 rounded text-js">undefined</span>
          </p>

          <Link
            href="/"
            className="bg-gray-900 text-js px-6 py-3 rounded-md hover:bg-gray-800 transition-all transform hover:-translate-y-1 font-bold"
          >
