    ...
    <Layout>
      <SEO
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content: `${speaker.name}, JavaScript, ZurichJS, tech talks, ${speaker.talks.flatMap((talk) => talk.tags || []).join(", ")}`,
          },
        ]}
      />
            ...
            speaker.talks
              ?.toSorted((a, b) => {
                ...
                const getLatestDate = (talk: Talk) => {
                  ...
                  return new Date(
                    Math.max(...talk.events.map((event) => new Date(event.datetime).getTime())),
                  );
                };
              ...
              .map((talk, index) => {
                ...
                const upcoming =
                  hasEvents && talk.events?.some((event) => new Date(event.datetime) > new Date());
          ...
          <div className="md:flex">
            <div className="md:w-2/3 p-8">
              ...
              <p className="text-lg mb-6">
                If you&apos;re passionate about JavaScript and have knowledge to share, we&apos;d
                love to have you speak at one of our upcoming meetups!
              </p>
              <Button
                href="/cfp"
                variant="primary"
