...
export default function AdminFeedbackLinks({ speakers }: AdminFeedbackLinksProps) {
          ...
          (speaker) =>
            ...
            speaker.talks.some(
              (talk) =>
                ...
                talk.events.some((event) => event.title.toLowerCase().includes(term)),
            ),
        ),
      );
    }
  ...
  return (
    <Layout>
      <SEO
        title="Speaker Feedback Links Admin | ZurichJS"
        description={
          "Generate and copy feedback links for speakers to share with them. These links give speakers access to view all feedback submitted for their talks."
        }
      />
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="mb-8">
          ...
          <p className="mb-4">
            Generate and copy feedback links for speakers to share with them. These links give
            speakers access to view all feedback submitted for their talks.
          </p>
        ...
        <div className="mb-12 bg-yellow-50 p-6 rounded-lg border border-yellow-200">
          ...
          <p className="mb-4">
            Share these links with attendees to collect feedback for specific events. The link puts
            the event page in &quot;feedback mode&quot; where attendees can rate talks.
          </p>
          ...
          <div className="space-y-4 mt-6">
            {allEvents
              ...
              .map((event) => (
                <div
                  key={event.id}
                  className="bg-white p-4 rounded-lg border border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4"
                >
                  <div>
        ...
        <div className="mb-12 bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="mb-4">
            Customize the email that will be sent to speakers with their feedback link. Use
            &quot;&#123;&#123;FEEDBACK_LINK&#125;&#125;&quot; as a placeholder for the actual link.
          </p>
                  ...
                  {speakerLinks[speaker.id] && (
                    <div className="mb-4 p-3 bg-gray-50 rounded-lg flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-md text-sm flex items-center whitespace-nowrap ${
