        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-700 mb-8">
              Your purchase was successful. You will receive a confirmation email shortly with all
              the details.
            </p>
            ...
            {referrerInfo && (
              <div className="bg-teal-50 border border-teal-100 rounded-lg p-4 mb-6">
                <p className="text-teal-800">
                  Thanks for using a referral link! We&apos;ve credited your friend with ZurichJS
                  points.
                </p>
              </div>
            )}
            ...
            <div className="space-y-4">
              <Button href="/profile" variant="primary" className="w-full">
                Go to Your Profile
              </Button>
