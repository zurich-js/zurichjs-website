...
import { Calendar, Clock, Users, Share2, ChevronLeft, Shield, Lock, Terminal, AlertTriangle, CheckCircle } from 'lucide-react';
    ...
    const milestones = [
        {
            ...
            bgColor: 'bg-green-50',
            icon: '🐦',
            extraInfo: !earlyBirdSoldOut && now < earlyBirdEnd ? `${Math.max(0, 15 - soldTickets)} early bird seats left` : null
        },
        {
...
export default function AISecuritySnykWorkshopPage({ speakers }: WorkshopPageProps) {
    ...
    const workshop: WorkshopDetails = {
        ...
        description: "Join Liran Tal, Developer Advocate at Snyk and renowned security expert, for an intensive hands-on workshop on AI security. Learn how to build secure AI-native applications, work with MCP servers, and protect LLM-powered systems from emerging threats. Walk away with a Snyk AI Security Certificate and practical skills you can apply immediately.",
        maxAttendees: 30,
        speakers: speakers,
        topics: [
            {
                title: "AI-Native Applications",
                description: "Introduction to building modern AI-native applications and understanding their unique security challenges.",
                icon: <Terminal className="text-blue-600" size={24} />
            },
            {
                title: "Building MCP Servers",
                description: "Hands-on experience creating and deploying Model Context Protocol (MCP) servers for AI applications.",
                icon: <Shield className="text-amber-600" size={24} />
            },
            {
                title: "MCP Security Deep Dive",
                description: "Learn advanced security patterns and best practices for securing MCP implementations.",
                icon: <Lock className="text-green-600" size={24} />
            },
            {
                title: "Exploiting LLM Applications",
                description: "Understand common vulnerabilities in LLM-powered applications and how to defend against them.",
                icon: <AlertTriangle className="text-purple-600" size={24} />
            },
            {
                title: "AI Security Best Practices",
                description: "Comprehensive best practices for developing secure, production-ready AI-native applications.",
        ...
        phases: [
            {
                ...
                duration: "20 minutes",
                description: "Overview of AI-native architecture, common patterns, and unique security considerations",
                activities: [
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                            ...
                            <div className="lg:col-span-7 order-1">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 lg:mb-10">
                                    ...
                                    <div className="bg-white rounded-xl p-4 shadow-sm border border-black/10 flex flex-col justify-center items-center text-center min-h-[80px]">
                                        <div className="text-sm lg:text-base font-bold text-black mb-1">15:30-18:00</div>
                                ...
                                <div className="lg:hidden">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        ...
                                        <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                                            ...
                                            <span className="text-sm font-medium text-gray-800">Exploit & Defend LLMs</span>
                                        </div>
                                        <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                                            <div className="text-2xl">✅</div>
                                        ...
                                        {workshop.speakers.map((speaker) => (
                                            <div key={speaker.id}>
                                                ...
                                                <div className="flex flex-wrap gap-2 justify-center mb-6">
                                                    <span className="bg-js/10 text-black px-3 py-1 rounded-full text-xs font-semibold border border-js/20">Security Expert</span>
                                                    <span className="bg-js/10 text-black px-3 py-1 rounded-full text-xs font-semibold border border-js/20">AI Security</span>
                                                    <span className="bg-js/10 text-black px-3 py-1 rounded-full text-xs font-semibold border border-js/20">DevSecOps</span>
                                                </div>
                                                ...
                                                <div className="text-center">
                                                    <div className="inline-flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-lg border border-gray-200">
                                                        ...
                                                        <span className="text-xs font-semibold text-gray-700">Snyk Developer Advocate</span>
                                                    </div>
                                                </div>
                            ...
                            >
                                ...
                                <div className="prose prose-lg max-w-none">
                                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                                        Join <strong>Liran Tal</strong>, Developer Advocate at Snyk and renowned security expert, for an intensive hands-on workshop on AI security. This workshop will take you through the complete lifecycle of building, securing, and testing AI-native applications with a focus on practical, real-world scenarios.
                                    </p>
                                    <p className="text-gray-700 text-lg leading-relaxed">
                                        You&apos;ll learn how to build secure Model Context Protocol (MCP) servers, understand common vulnerabilities in LLM-powered applications, and implement best practices for production-ready AI systems. Walk away with a <strong>Snyk AI Security Certificate</strong> and practical skills you can apply immediately to your projects.
                                    </p>
                                </div>
                            </motion.div>
                ...
                >
                    ...
                    <div className="space-y-4">
                                ...
                                <div className="px-6 pb-6 animate-fadeIn">
                                    ...
                                    <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg">
                                        <p className="text-sm font-medium text-gray-800">
                                            <span className="text-blue-600 font-bold">Perfect for:</span> Anyone building or securing AI applications who wants hands-on experience with the latest security patterns and best practices.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            {openFaq === 'prerequisites' && (
                                <div className="px-6 pb-6 animate-fadeIn">
                                    ...
                                    <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg">
                                        <p className="text-sm font-medium text-gray-800">
                                            <span className="text-blue-600 font-bold">Note:</span> This is a hands-on workshop. Bring your laptop with Node.js installed and come ready to code!
                                        </p>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            >
                                <span className="font-bold text-lg text-gray-900">What&apos;s included with the certificate?</span>
                                <span className={`ml-4 transition-transform ${openFaq === 'certificate' ? 'rotate-180' : ''}`}>
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                </span>
                                    ...
                                    <div className="bg-blue-50 p-4 rounded-lg">
                                        <ul className="space-y-2 text-sm">
                                            <li className="flex items-start">
                                                ...
                                                <span className="text-gray-700">Official Snyk AI Security Certificate of completion</span>
                                            </li>
                                            <li className="flex items-start">
                                                <span className="text-blue-500 mr-2">✓</span>
                                                <span className="text-gray-700">Verifiable digital credential for LinkedIn and resumes</span>
                                            </li>
                                            <li className="flex items-start">
                                                <span className="text-blue-500 mr-2">✓</span>
                                                <span className="text-gray-700">Access to exclusive Snyk AI security resources</span>
                                            </li>
                                            <li className="flex items-start">
                                                <span className="text-blue-500 mr-2">✓</span>
                                                <span className="text-gray-700">Ongoing updates on AI security best practices</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
