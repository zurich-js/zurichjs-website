          ...
          <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-6 sm:p-8 md:p-10">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                We&apos;d love to get to know you better so we can tailor ZurichJS events, content,
                and opportunities to match your interests.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="p-5 bg-gray-50 rounded-lg space-y-6">
                ...
                <div className="mb-6">
                  <label
                    htmlFor="role"
                    className="block text-gray-700 font-medium mb-2 text-sm uppercase tracking-wide"
                  >
              ...
              <div className="p-5 bg-gray-50 rounded-lg">
                <h3 className="text-xl font-semibold text-gray-800 border-b border-gray-200 pb-2 mb-4">
                  Your JavaScript Interests
                </h3>
                <p className="text-gray-600 mb-4">
                  Select all topics you&apos;re interested in learning more about or discussing at
                  our events.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  {interestOptions.map((interest) => (
                    <div
                      key={interest}
                      className="flex items-start bg-white p-3 rounded border border-gray-200 hover:border-yellow-400 transition-all"
                    >
                      <input
                        type="checkbox"
                ...
                <div className="flex items-start">
                  ...
                  <label htmlFor="newsletter" className="ml-3 text-gray-700">
                    ...
                    <span className="text-sm text-gray-500">
                      Check this box if you don&apos;t want to receive our newsletter with upcoming
