  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="You've been invited to join the ZurichJS community by a friend. Join our vibrant JavaScript community in Zurich!"
        />
      </Head>
      <div className="w-full pt-16 sm:pt-24 pb-16 px-4 sm:px-6 flex items-center justify-center min-h-[70vh]">
        <div className="max-w-md w-full">
            ...
            {referrer.loading ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-gray-600">
                  The invitation may have expired or is invalid. You can still join ZurichJS by
              ...
              <div className="text-center py-4">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 rounded-lg mb-6">
                  <p className="text-purple-800 font-medium mb-2">
                    Let&apos;s create a referral train!
                  </p>
                  <p className="text-gray-700 mb-4">
                    Invite someone to join in on the fun and earn credits for workshops, events, and
                    exclusive merch!
                  </p>
                </div>
                  ...
                  {referralLink && (
                    <div className="flex flex-col items-center mt-6 border border-purple-100 rounded-lg p-4 bg-gradient-to-r from-purple-50 to-indigo-50">
                      ...
                      <p className="text-xs text-purple-700 mt-3">
                        You&apos;ll earn points for each new member who joins with your link!
                      </p>
                    </div>
                  )}
                </div>
              ...
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">
                    Create an account to access exclusive workshops, events, and connect with the
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <p className="text-sm text-indigo-900 flex-1">
                        <span className="font-medium">Priority Registration</span> for workshops and
                        events with limited seating
                      </p>
                    </div>
                    <div className="flex items-start">
                      <div className="bg-indigo-100 p-1 rounded-full mr-3">
                      ...
                      <p className="text-sm text-indigo-900 flex-1">
                        <span className="font-medium">Express Checkout</span> for faster
                        registration with saved preferences
                      </p>
                    </div>
                    <div className="flex items-start">
                      <div className="bg-indigo-100 p-1 rounded-full mr-3">
                      ...
                      <p className="text-sm text-indigo-900 flex-1">
                        <span className="font-medium">Networking Events</span> to connect with local
                    ...
                    <div className="flex items-start">
                      ...
                      <p className="text-sm text-indigo-900 flex-1">
                        <span className="font-medium">Community Slack</span> for job opportunities
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-indigo-900">
                        Loyalty rewards for active participation
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-indigo-500 mr-2">✓</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-indigo-500 mr-2">✓</span>
                      <span className="text-indigo-900">
                        Streamlined registration with saved preferences
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-indigo-500 mr-2">✓</span>
                ...
                <div className="space-y-4">
                  <SignInButton mode="modal" forceRedirectUrl={`/invite/${token}?signup=complete`}>
                    <button className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 focus:ring-indigo-400 text-white font-medium py-3 text-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1 border-0 rounded-md">
                      Create Your Account
                    </button>
                  </SignInButton>
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/policies/terms-and-conditions" className="text-blue-600 hover:underline">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/policies/privacy-policy" className="text-blue-600 hover:underline">
              Privacy Policy
            </Link>
            .
          </p>
