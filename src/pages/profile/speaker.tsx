  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        if (!isCancelled) {
          setError(
            loadError instanceof Error ? loadError.message : "Failed to load speaker profile",
          );
        }
      } finally {
        if (!isCancelled) {
    ...
    return (
      <Layout>
        <div className="w-full pt-20 pb-16 px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center text-lg text-gray-600">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              Update the speaker details we use to pre-fill CFP submissions and introduce you on
              ZurichJS.
            </p>
          </div>
          ...
          >
            ...
            <div className="mt-4 mb-8">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Recommended: square image, at least 400x400px. Uploading a new image replaces your
                existing one.
              </p>
            </div>
