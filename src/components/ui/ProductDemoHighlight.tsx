...
const ProductDemoHighlight: React.FC<ProductDemoHighlightProps> = ({
  productDemos,
  isUpcoming = false,
}) => {
    ...
    <div className="mt-6 mb-2">
      ...
      <div className="space-y-4">
        {productDemos.map((demo) => (
          <div
            key={demo._id}
            className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 shadow-sm border border-purple-200 hover:shadow-md transition-shadow"
          >
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
              ...
              <div className="flex-grow text-center sm:text-left">
                ...
                {demo.description && (
                  <p className="text-sm text-gray-600 mt-1 mb-3 line-clamp-2">{demo.description}</p>
                )}
