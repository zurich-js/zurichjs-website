      ...
      <div className={`mt-8 ${className}`}>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 text-center border border-indigo-100">
          ...
          <h3 className="text-xl font-semibold text-indigo-800 mb-3">
            No Product Demo Feedback Yet
          </h3>
          <p className="text-gray-600 max-w-md mx-auto">
            There is no product demo feedback available for your talks yet. Once attendees provide
            feedback on your product demos, you&apos;ll see analytics here.
          </p>
        </div>
      </div>
    );
          ...
          <div className="flex flex-col md:flex-row items-start gap-6">
            <div className="bg-white p-4 rounded-lg shadow-sm flex-shrink-0 border border-indigo-100">
              <div className="text-4xl font-bold text-indigo-700">
                {productFeedbackByProduct.length}
              </div>
              <div className="text-gray-600 text-sm">
                Product{productFeedbackByProduct.length !== 1 ? "s" : ""}
              </div>
            </div>
            <div>
              ...
              <p className="text-gray-700">
                This dashboard provides comprehensive insights from audience feedback on your
                product demonstrations. Use these analytics to understand audience interests,
                  ...
                  <div>
                    ...
                    {product.sentimentAnalysis && (
                      <div className="mt-3 pt-3 border-t border-indigo-200">
                        ...
                        <p className="text-sm text-indigo-800 mt-1">{getRecommendation(product)}</p>
                      </div>
                    )}
                  </div>
                </div>
                      ...
                      <div className="flex flex-col items-center mb-4">
                        ...
                        <div className={`mt-1 text-xl font-bold ${getSentimentColor(product)}`}>
                          ...
                          <span className="ml-1 relative group">
                            <svg
                              className="w-4 h-4 text-gray-400 inline cursor-pointer"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                              xmlns="http://www.w3.org/2000/svg"
                            >
                              ...
                              <span className="ml-1 relative group">
                                ...
                                <div className="absolute bottom-full left-0 mb-2 w-72 p-3 bg-white shadow-lg rounded-lg border border-gray-200 text-xs text-left opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-10">
                                  ...
                                  <p className="text-gray-600 mb-2">
                                    Our sentiment analysis classifies feedback into three categories
                                    based on ratings:
                                  </p>
                                  <ul className="list-disc ml-3 space-y-1 text-gray-600">
                                    <li>
                                      <span className="text-green-600 font-medium">Positive</span>:
                                      Ratings of 4-5 out of 5
                                    </li>
                                    <li>
                          ...
                          <div className="bg-gray-100 rounded-full h-3 overflow-hidden mb-2">
                            <div className="flex h-full">
                              <div
                                ...
                                style={{
                                  width: `${(product.sentimentAnalysis.positive / product.totalFeedback) * 100}%`,
                                }}
                              ></div>
                              <div
                                className="bg-yellow-400 h-full transition-all duration-500"
                                style={{
                                  width: `${(product.sentimentAnalysis.neutral / product.totalFeedback) * 100}%`,
                                }}
                              ></div>
                              <div
                                className="bg-red-500 h-full transition-all duration-500"
                                style={{
                                  width: `${(product.sentimentAnalysis.negative / product.totalFeedback) * 100}%`,
                                }}
                              ></div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-1 text-center">
                            <div className="bg-green-50 rounded-md p-1.5 border border-green-100">
                              <div className="text-sm font-semibold text-green-700">
                                {product.sentimentAnalysis.positive}
                              </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="space-y-3">
                        {product.interests
                          .slice(0, 5)
                          .map((item: ProductInterest, index: number) => (
                            <div key={index}>
                              <div className="flex justify-between text-sm mb-1">
                                <span className="text-gray-700">{item.interest}</span>
                                <span className="text-indigo-700 font-medium">
                                  {Math.round((item.count / product.totalFeedback) * 100)}%
                                </span>
                              </div>
                              <div className="w-full bg-gray-200 rounded-full h-2">
                                <div
                                  ...
                                  style={{
                                    width: `${(item.count / product.totalFeedback) * 100}%`,
                                  }}
                                ></div>
                              </div>
                            </div>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="flex flex-wrap gap-2">
                        {product.learningPreferences.map(
                          (item: ProductLearningPreference, index: number) => (
                            <div
                              key={index}
                    ...
                    <details className="group mb-6">
                      ...
                      <div className="mt-3 bg-gray-50 rounded-lg p-4">
                        <p className="text-sm text-gray-600 mb-3">
                          Attendees who provided feedback ({product.contactInfo.length})
                        </p>
                                ...
                                <div className="flex items-center">
                                  <div
                                    className={`w-2 h-2 rounded-full mr-2 ${
                                      contact.feedbackType === "positive"
                                        ? "bg-green-500"
                                        : contact.feedbackType === "negative"
                                          ? "bg-red-500"
                                          : "bg-yellow-400"
                                    }`}
                                  ></div>
                ...
                <div className="bg-gray-50">
                  <div role="tablist" className="flex border-b border-gray-200">
                    <button
                      role="tab"
                      aria-selected={
                        !activeTabMap[product.productId] ||
                        activeTabMap[product.productId] === "feedback"
                      }
...
export default function SpeakerFeedbackPage({ feedbackData, error }: SpeakerFeedbackPageProps) {
  ...
  const processFeedbackData = () => {
      ...
      if (item.productFeedback) {
        ...
        if (normalizedProductId) {
          ...
          if (productData) {
            ...
            if (
              item.productFeedback.learningPreferences &&
              Array.isArray(item.productFeedback.learningPreferences)
            ) {
              productData.learningPreferences = [
                ...productData.learningPreferences,
                ...item.productFeedback.learningPreferences,
              ];
            }
            if (
              item.productFeedback.questions &&
              typeof item.productFeedback.questions === "string"
            ) {
    ...
    const feedbackByTalk = Array.from(talkMap.values()).map((talk) => {
      ...
      const productStats = Array.from(talkProductMap.values()).map((product) => {
        ...
        const interestCounts = product.interests.reduce(
          (counts: Record<string, number>, interest: string) => {
    ...
    const productFeedbackByProduct = Array.from(productMap.values()).map((product) => {
      ...
      const learningCounts = product.learningPreferences.reduce(
        (counts: Record<string, number>, pref: string) => {
      ...
      const positivePercentage =
        totalFeedback > 0 ? Math.round((sentimentAnalysis.positive / totalFeedback) * 100) : 0;
      const negativePercentage =
        totalFeedback > 0 ? Math.round((sentimentAnalysis.negative / totalFeedback) * 100) : 0;
  ...
  const productRatingPercentage = summary.hasProductFeedback
    ? (summary.averageProductRating / 5) * 100
    : 0;
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {/* Product Demo Rating */}
              <div
                className={`bg-white rounded-xl shadow-sm border ${summary.hasProductFeedback ? "border-purple-200" : "border-gray-200"} p-6`}
              >
                <h3 className="text-gray-500 text-sm font-medium mb-2">Product Demo Rating</h3>
                {summary.hasProductFeedback ? (
                  <>
                    <div className="flex items-baseline">
                      <div className="text-3xl font-bold mr-2 text-purple-700">
                        {summary.averageProductRating.toFixed(1)}
                      </div>
                      <div className="text-gray-500 text-sm">out of 5.0</div>
                    </div>
                    <div className="mt-3">
                  ...
                  <div className="flex items-center h-12 text-gray-400">No product feedback</div>
                )}
              </div>
              ...
              >
                ...
                {summary.hasProductFeedback ? (
                  <>
                    ...
                    <div className="mt-3 text-sm text-gray-500">
                      Across {productFeedbackByProduct.length}{" "}
                      {productFeedbackByProduct.length === 1 ? "product" : "products"}
                    </div>
                  </>
                ) : (
                  <div className="flex items-center h-12 text-gray-400">No product feedback</div>
      ...
      <div className="container mx-auto px-6 py-10">
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center mb-4">
                      <div className="flex mr-2">{renderStars(talk.averageRating)}</div>
                      <span className="text-gray-600">
                        {talk.averageRating.toFixed(1)} from {talk.totalFeedback}{" "}
                        {talk.totalFeedback === 1 ? "review" : "reviews"}
                      </span>
                    </div>
        ...
        <div
          style={{
            display: activeTab === "products" && summary.hasProductFeedback ? "block" : "none",
          }}
        >
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <ProductAnalytics
              productFeedbackByProduct={
                productFeedbackByProduct as unknown as ProductFeedbackData[]
              }
            />
          </motion.div>
        </div>
