  ...
  const phases = [
    {
      ...
      concepts: ["LLM applications vs agents", "Autonomy and decision-making", "Agentic workflows"],
    },
    {
      ...
      concepts: ["Function calling", "Tool schemas", "Error propagation"],
    },
    {
      ...
      concepts: ["ReAct pattern", "Context pruning", "Short vs long-term memory"],
    },
    {
      ...
      concepts: ["Human oversight patterns", "Fallback strategies", "Idempotency and retries"],
    },
    {
      ...
      concepts: ["Agent evals", "Tracing agentic systems", "Production readiness checklist"],
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "The workshop is designed for developers who are comfortable with general software development. Prior experience with LLMs is helpful but not strictly required — Davy will cover the core concepts from the ground up.",
    },
    {
      id: "hands-on",
      question: "How hands-on is the workshop?",
      answer:
        "The session is practical and example-driven. You will follow along with code examples and real-world design patterns rather than purely theory.",
    },
    {
      id: "refund",
      question: "What is the refund policy?",
      answer:
        "Tickets are non-refundable but can be transferred to another attendee. Please contact us at hello@zurichjs.com if you need to make changes.",
    },
    {
      id: "recording",
      question: "Will the workshop be recorded?",
      answer:
        "The workshop is in-person only and will not be recorded. This ensures a more interactive and focused experience for all participants.",
    },
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-7 order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  <Button variant="primary" onClick={scrollToRegistration}>
                    {primaryCtaLabel}
                  </Button>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-black/10">
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      {speaker?.bio ??
                        "Davy has hands-on experience building AI agent systems and will walk you through the core building blocks behind modern AI agent systems, explaining how to design them in a more robust, predictable, and production-minded way."}
                    </p>
                  </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="prose prose-lg text-gray-700 space-y-4">
                <p>
                  AI agents are easy to demo, but much harder to make reliable in real-world
                  applications. In this hands-on workshop, Davy will walk participants through the
                  core building blocks behind modern AI agent systems and explain how to design them
                  in a more robust, predictable, and production-minded way.
                </p>
                <p>
                  The session will cover how agents use tools, how agent loops work, how to manage
                  context effectively, and when to introduce human-in-the-loop approvals.
                  Participants will also explore the practical challenges of reliability,
                  evaluation, and system design as they move from simple LLM interactions to more
                  capable AI workflows.
                </p>
                <p>
                  This workshop is designed for developers seeking a practical introduction to
                  building AI agents that do more than just look impressive in a demo.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            {phases.map((phase, index) => (
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  {index < phases.length - 1 && <div className="w-0.5 bg-gray-200 flex-1 mt-2" />}
                </div>
      ...
      <Section className="bg-black" id="registrationContainer">
        <div className="container mx-auto px-4 py-12 lg:py-16">
          ...
          >
            ...
            <p className="max-w-xl mx-auto">{registrationDetails}</p>
          </motion.div>
      ...
      <Section className="bg-js">
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <p className="text-gray-800 mb-6 max-w-lg mx-auto">
            Join Davy on April 21st and leave with a clear mental model for building reliable,
