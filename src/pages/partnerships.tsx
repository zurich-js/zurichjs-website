  ...
  const partnershipTiers: PartnershipTier[] = [
    ...
    },
    {
      ...
      pricingOptions: [
        ...
        {
          label: "Venue + Speaker Travel",
          amount: "CHF 1,500-2,500",
          note: "(becomes Community Friend)",
        },
      ],
      perks: [
      ...
      description:
        "Host our meetup at your venue. Covering speaker travel (~CHF 1,500-2,500) automatically qualifies you as Community Friend sponsor.",
    },
  ];
    ...
    <Layout>
      <SEO
        ...
        openGraph={{
          ...
          description:
            "Support the ZurichJS community and connect with JavaScript developers in Zurich.",
        ...
        >
          ...
          <div className="space-y-6 text-lg md:text-xl text-gray-800 leading-relaxed mb-10">
            <p className="text-2xl font-semibold text-gray-900">
              900 members. Local and international speakers from companies like Google, AWS,
              Cloudflare, and more. Attendees and speakers have travelled in for the meetup from 7+
              countries.
            </p>
            <p>
              In less than a year, ZurichJS went from a side project to a growing developer
              community—built on trust, quality content, and authentic connections.
            </p>
            <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded">
              <p className="font-semibold text-gray-900">
                Partner with us to reach engaged developers who actually show up, connect with
                international tech talent, and build brand trust in the European JavaScript
                ecosystem.
              </p>
            </div>
          </div>
              ...
              <>
                ...
                <form onSubmit={handleQuickInterest} className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      setQuickInterest((prev) => ({ ...prev, name: e.target.value }))
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuickInterest((prev) => ({ ...prev, email: e.target.value }))
                    }
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    disabled={quickInterest.isSubmitting}
                  />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed mb-4">
              <strong className="text-gray-900">International reach:</strong> Attendees and speakers
              have travelled in for the meetup from the Swiss French side 🇨🇭, Germany 🇩🇪, France 🇫🇷,
              Belgium 🇧🇪, Italy 🇮🇹, Greece 🇬🇷, and Albania 🇦🇱.
            </p>
            <p className="text-lg text-gray-800 leading-relaxed">
              <strong className="text-gray-900">Organic growth:</strong> Word of mouth and social
              channels drive our reach. We&apos;re now a recognized name within the wider European
              JavaScript network.
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We&apos;re not just another meetup. We&apos;re building a trusted platform that
              developers actually show up for.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Conference-level content in an accessible meetup format. No shallow networking—just
                real technical depth and meaningful connections.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                From zero to 900 members in under a year. 70-80% show-up rate. People flying in from
                neighboring countries. This is a community that actually engages.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                Authenticity and transparency are non-negotiable. We&apos;ve earned community trust
                by delivering consistently—and we protect it fiercely.
              </p>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description:
                    "Co-founder · Frontend specialist, passionate about inclusive tech communities",
                },
                {
                  ...
                  description:
                    "Frontend developer with a flair for sleek, user-friendly experiences",
                },
              ].map((member, index) => (
          ...
          >
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 text-left max-w-3xl mx-auto rounded">
              <p className="text-gray-800 leading-relaxed">
                <strong className="text-gray-900">Transparency note:</strong> Food & drinks are
                appreciated, but they only cover one evening. Real costs include international
                speaker travel, software tools, content production, and building a brand developers
                trust.
              </p>
            </div>
          </motion.div>
      ...
      <Section variant="gray" padding="lg">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Community-first with conference-level content. We feature local talent alongside
              industry leaders from companies like Google, AWS, Cloudflare, Node.js TSC, Smashing
              Magazine, and more.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 mb-6">
            {[
              {
                name: "Matteo Collina",
                bio: "Co-Founder/CTO @ Platformatic · Node.js TSC member · Fastify Lead Maintainer",
              },
              {
                name: "Elian Van Cutsem",
                bio: "Lead DevRel at React Bricks · CTO at Vulpo · Astro Maintainer · devs.gent meetup organiser",
              },
              ...
              { name: "Harshil Agrawal", bio: "Developer Educator @ Cloudflare" },
              {
                ...
                bio: "Senior Developer Advocate for Dynatrace Apps · Developer · Musician",
              },
              ...
              {
                name: "Wout Mertens",
                bio: "Head of Product at StratoKit SA · Qwik Core Contributor",
              },
              {
                name: "Nico Martin",
                bio: "Frontend Developer and Google Developer Expert for Web Technologies and AI",
              },
              { name: "Adam Berecz", bio: "Founder of Vueform" },
              {
                name: "Christian Wörz",
                bio: "Expert Fullstack Engineer · Microsoft MVP (Web Dev & Dev Tools)",
              },
              {
                name: "Savas Vedova",
                bio: "Staff Frontend Engineer at GitLab · Founder at Stormkit",
              },
              ...
              {
                name: "Alex Suzuki",
                bio: "Solopreneur · Author of STRICH (Barcode Scanning for Web Apps) · Father of two",
              },
          ...
          >
            <p className="text-lg text-gray-800 leading-relaxed mb-4">
              We carefully balance <strong>community events</strong> to bring new talent to light
              and <strong>PRO events</strong> that bring in the best speakers at the meetup level.
              Every speaker is vetted, supported, and set up for success.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border-l-4 border-blue-600 max-w-3xl mx-auto text-left">
              <p className="text-gray-800 leading-relaxed">
                <strong className="text-gray-900">💡 Pro tip:</strong> Not sure which tier fits? Use
                the quick form above or scroll to the bottom to start a conversation—we&apos;ll help
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-6 lg:mb-8">
            {partnershipTiers.slice(0, 4).map((tier, index) => (
              ...
              >
                {/* Tier Header */}
                <div
                  className={`p-6 ${tier.highlighted ? "bg-gradient-to-br from-yellow-50 to-amber-50" : "bg-gray-50"}`}
                >
                  ...
                  <ul className="space-y-3 mb-6 flex-grow">
                    {tier.perks.map((perk, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        <CheckCircle
                          className={`${tier.highlighted ? "text-yellow-500" : "text-blue-500"} mt-0.5 flex-shrink-0`}
                          size={18}
                        />
                  ...
                  >
                    <div className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left">
                      ...
                      <div className="flex-1">
                        <h4 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                          {partner.name}
                        </h4>
                        {partner.blurb && (
        ...
        <Section variant="white">
          ...
          {venuePartners.filter((p) => !p.sponsorshipTier).length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-700 mb-8 max-w-3xl">
                Our venue partners generously provide their spaces for ZurichJS meetups, helping us
                create memorable events for our community.
              </p>
          ...
          {conferencePartners.filter((p) => !p.sponsorshipTier).length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-700 mb-8 max-w-3xl">
                Our conference partners offer exclusive discounts and special access to ZurichJS
                members for their events.
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 sm:gap-8 lg:gap-10 items-center justify-items-center">
                {conferencePartners
                  .filter((p) => !p.sponsorshipTier)
          ...
          {communityPartners.filter((p) => !p.sponsorshipTier).length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-700 mb-8 max-w-3xl">
                Our community partners are fellow tech communities that we collaborate with to
                strengthen the JavaScript ecosystem in our region.
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 sm:gap-8 lg:gap-10 items-center justify-items-center">
                {communityPartners
                  .filter((p) => !p.sponsorshipTier)
          ...
          {supportingPartners.filter((p) => !p.sponsorshipTier).length > 0 && (
            <div className="mb-20">
              ...
              <p className="text-gray-700 mb-8 max-w-3xl">
                Our supporting partners provide valuable resources, tools, and services that help us
                run ZurichJS more effectively.
              </p>
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 sm:gap-8 lg:gap-10 items-center justify-items-center">
                {supportingPartners
                  .filter((p) => !p.sponsorshipTier)
      ...
      <Section variant="gray" padding="lg">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We&apos;re grateful to all the companies and organizations that have supported ZurichJS
            over the years.
          </p>
        </motion.div>
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-900 leading-relaxed mb-8">
            Join 900+ developers, local and international speakers from companies like Google, AWS,
            and more, and a community that actually shows up. Partner with ZurichJS today.
          </p>
      ...
      <Section variant="white" id="inquiry-form">
        ...
        >
          ...
          <p className="text-xl text-gray-800 leading-relaxed mb-4 max-w-2xl">
            Interested in reaching 900+ engaged developers? We&apos;ll respond within 24-48 hours to
          ...
          {formState.submitted ? (
            ...
            >
              ...
              <p className="mb-6 text-gray-700">
                We&apos;ve received your partnership inquiry and we&apos;re super excited about the
                possibility of working together! Our team will reach out to you within 48 hours to
                discuss next steps.
              </p>
              <p className="mb-6 text-gray-700">
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-900 leading-relaxed mb-8">
            Partner with a community built on trust, quality, and authenticity. When you work with
            us, you&apos;re not just buying exposure—you&apos;re backing a platform that developers
