        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-800 max-w-4xl">
              In November 2024, we hosted our first JavaScript meetup in Zurich with nothing but
              personal savings and a belief that this city&apos;s developer community deserved
              better. Today, <strong>ZurichJS</strong> brings together 900+ developers every
              month—people who travel from Basel, Winterthur, even across borders—because
              there&apos;s something powerful about being in the same room with people who
              don&apos;t look or think exactly like you.
            </p>

            <div className="bg-white p-8 rounded-lg shadow-lg mb-12">
              <h2 className="text-2xl font-bold mb-4">Why We Started This</h2>
              <p className="text-gray-700 mb-4">
                After the pandemic, Zurich&apos;s developer meetup scene had become a piece of
                history. Monthly gatherings disappeared. The energy was gone. In July 2024, our
                founders met at a ReactJS meetup and realized: the Zurich tech space is filled with
                potential, and we needed to shape that into reality.
              </p>
              <p className="text-gray-700 mb-4">
                Our first event validated everything. 70% confirmed attendance. People showing up
                not just for the tech, but for face-to-face connection across backgrounds,
                languages, and experience levels. Because in an age of online everything,
                there&apos;s value in seeing who&apos;s actually in your city and realizing you
                belong in this industry.
              </p>
              <p className="text-gray-700">
                Less than a year later, we&apos;re a registered Swiss non-profit association,
                recognized across Europe, hosting consistent events that people trust.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Developers from Zurich, Winterthur, Basel, and beyond. Consistent 70-80%
                  attendance rate.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  All meetups are free. Non-profit model funded by community donations. No barriers
                  to learning.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg mb-12">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="mb-4">
                  We started with zero. No social media followers. No sponsors. No speakers. Just a
                  LinkedIn page, an inactive Meetup group with no past events, and relationships
                  that let us host in borrowed spaces.
                </p>

                <p className="mb-4">
                  What we did have: a belief that <strong>Trust, Authenticity, and Quality</strong>{" "}
                  matter more than scale. That conference-level experiences can happen in relaxed
                  meetup spaces. That everyone should feel included, regardless of background or
                  experience level.
                </p>
                ...
                <ul className="space-y-3 mb-6">
                  <li>
                    <strong>Consistent Rhythm</strong> - Monthly events that people trust. Same
                    quality, every time. 50-100 RSVPs per meetup with 70-80% actual attendance.
                  </li>
                  <li>
                    <strong>Real Growth</strong> - Organic expansion through word of mouth. New
                    members join monthly while loyal faces keep returning. This balance lets us
                    scale without losing character.
                  </li>
                  <li>
                    <strong>Community Sustains Itself</strong> - After almost every event, new
                    volunteers step forward. Members give feedback. Speakers refine their talks.
                    It&apos;s become our DNA.
                  </li>
                  <li>
                    <strong>Geographic Reach</strong> - People travel from Winterthur, Basel, Zug,
                    St. Gallen, even Konstanz. Our workshops showed us developers will cross borders
                    to be part of this.
                  </li>
                  <li>
                    <strong>Lasting Impact</strong> - Talks live on through recap posts, SEO-indexed
                    event pages, social channels. Content amplifies long after the event ends.
                  </li>
                  <li>
                    <strong>Non-Profit Model</strong> - Registered Swiss association. Funded by
                    community donations. Every franc goes back into better events, better speakers,
                    better experiences.
                  </li>
                </ul>
                ...
                <ul className="space-y-2 mb-6">
                  <li>
                    <strong>Beginners</strong> - Learn from experienced developers and get started
                    with modern web development
                  </li>
                  <li>
                    <strong>Intermediate Developers</strong> - Deepen your knowledge and discover
                    new frameworks and tools
                  </li>
                  <li>
                    <strong>Senior Engineers</strong> - Share your expertise, stay current with
                    latest trends, and network
                  </li>
                  <li>
                    <strong>Career Changers</strong> - Connect with the community and learn about
                    job opportunities
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Tech Leads & CTOs</strong> - Scout talent and stay updated on technology
                    trends
                  </li>
                </ul>
                ...
                <p className="mb-4">
                  Our meetups are hosted in central Zurich at tech company offices, making them
                  easily accessible by public transport. We regularly welcome attendees from:
                </p>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold mb-6">
              Ready to Join Zurich&apos;s JavaScript Community?
            </h2>
