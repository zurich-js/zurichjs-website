      ...
      (event) =>
        ...
        event.talks.some(
          (talk) =>
            ...
            talk.speakers.some((speaker) => speaker.name.toLowerCase().includes(query)),
        ),
    );
    ...
    <Layout>
      <SEO
        ...
        openGraph={{
          ...
          title: `${activeTab === "upcoming" ? "Upcoming Events" : "Past Events"} | ZurichJS`,
          description:
            "Join the vibrant JavaScript community in Zurich! Check out our upcoming meetups, workshops, and talks for JavaScript enthusiasts of all levels.",
      ...
      <Section variant="gradient" padding="lg" className="mt-20">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8 text-gray-900">
            Awesome meetups for JS enthusiasts of all levels! Join us to learn, share, and connect
            with fellow developers in our super friendly community.
          </p>
                    ...
                    {event.description ? (
                      ...
                      <div className="mb-4">
                        <p className="text-gray-700 line-clamp-3 text-sm italic">
                          We&apos;re working on bringing this event to life! Check back soon for
                          more details on this exciting JavaScript gathering.
                        </p>
                      ...
                      {isClient && event.talks.length > 0 && (
                        <div className="mb-4">
                          <p className="font-bold text-sm mb-2 text-gray-900">
                            {event.talks.reduce(
                              (total, talk) => total + talk.speakers.length,
                              0,
                            ) === 1
                              ? "Speaker:"
                              : "Speakers:"}
        ...
        >
          <div className="lg:w-2/3 mb-8 lg:mb-0 lg:pr-10">
            ...
            <p className="text-xl mb-6">
              We&apos;re always looking for awesome speakers to share their JavaScript knowledge,
      ...
      <Section variant="white">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Got a cool office space? Want to spotlight your company to the JavaScript community?
            Consider hosting our next meetup!
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="mb-6 text-gray-900">
              We&apos;d love to bring the JavaScript magic to your space! Reach out and let&apos;s
