      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Join our interactive workshop to enhance your JavaScript knowledge and connect with
              the community.
            </p>
          ...
          >
            ...
            >
              {speakerImage && absoluteSpeakerImage ? (
                <img
                  src={
                    absoluteSpeakerImage.includes("?")
                      ? absoluteSpeakerImage
                      : `${absoluteSpeakerImage}?h=200&w=200&v=${timestamp}`
                  }
                  alt={speakerName}
                  width={100}
                  height={100}
