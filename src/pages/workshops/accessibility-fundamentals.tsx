...
export default function WorkshopPage({ speaker }: WorkshopPageProps) {
  ...
  const workshop: WorkshopDetails = {
    ...
    locationInfo: "TBD",
    description:
      "Prepare your web applications for the European Accessibility Act (EAA) with this comprehensive workshop on web accessibility fundamentals. Learn how to create inclusive digital experiences that comply with accessibility standards and regulations. This workshop covers essential concepts, practical techniques, and best practices to help you build accessible websites and applications. Through hands-on exercises and real-world examples, you'll gain the knowledge and skills to make your digital products accessible to everyone, including people with disabilities.",
    ...
    <Layout>
      ...
      <Section variant="gradient" padding="lg" className="mt-2 sm:mt-3">
        <div className="mb-3 sm:mb-4">
          <Link
            href="/workshops"
            className="inline-flex items-center text-black hover:underline text-sm sm:text-base"
          >
            ...
            <div className="rounded-xl overflow-hidden shadow-lg sm:shadow-xl bg-white p-5 sm:p-8 border-l-4 border-purple-600 lg:sticky lg:top-24 relative">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-600 mb-3">
                    Senior Frontend Engineer & Accessibility Expert
                  </p>
              ...
              <div className="bg-gray-50 p-5 rounded-lg mt-6 border border-gray-100">
                <p className="font-medium text-gray-700">
                  Limited to {workshop.maxAttendees} attendees
                </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed text-base">
                    Understand the principles of web accessibility, WCAG guidelines, and why
                  ...
                  <ul className="mt-2 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700 text-base">
                        Core accessibility principles and benefits
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-purple-500 mr-2 text-lg">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-purple-500 mr-2 text-lg">•</span>
                      <span className="text-gray-700 text-base">
                        Different types of disabilities and assistive technologies
                      </span>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  ...
                  <ul className="mt-2 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700 text-base">
                        Overview of EAA requirements and timelines
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2 text-lg">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2 text-lg">•</span>
                      <span className="text-gray-700 text-base">
                        Legal implications and business benefits
                      </span>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Semantic HTML</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Testing and Validation</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
            ...
            >
              ...
              <div className="mt-6 bg-yellow-50 border-l-4 border-js p-4 rounded-lg">
                <p className="text-sm sm:text-base font-medium text-gray-800">
                  ...
                  receive comprehensive learning materials, code examples, and accessibility
                  checklists to help implement accessibility in their own projects.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <div className="mt-4 sm:mt-6 bg-purple-50 border-l-4 border-purple-500 p-3 sm:p-4 rounded-lg">
                <p className="text-sm sm:text-base font-medium text-gray-800">
                  <span className="text-purple-600 font-bold">Perfect for:</span> Professionals
                  looking to ensure their digital products comply with accessibility standards and
            ...
            >
              ...
              <p className="mb-4 font-medium text-base">
                Sign up for the waitlist to be notified when registration opens for this
                comprehensive accessibility workshop!
              </p>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                This workshop is designed to provide a comprehensive introduction to web
                accessibility through a mix of theory and hands-on practice. You&apos;ll learn how
                to identify and fix common accessibility issues in real-world scenarios.
              </p>
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-lg">
                <p className="text-sm text-gray-800">
                  ...
                  <span className="font-bold">Experience level:</span> Beginner to Intermediate
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-1 text-center sm:text-left">
              ...
              <div className="mt-4 bg-blue-50 p-4 rounded-lg border-l-2 border-blue-400">
                <p className="text-gray-700 text-sm mb-2">
                  Aleksej is a passionate frontend developer with extensive experience in web
                  accessibility and inclusive design. He has helped numerous organizations implement
                  accessible solutions that comply with international standards.
                </p>
                <p className="text-gray-700 text-sm">
                  With a background in both development and user experience, Aleksej brings
                  practical insights into creating accessible digital products that work for
                  everyone. He specializes in helping teams meet compliance requirements while
      ...
      <Section variant="black">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-purple-500 to-yellow-500 p-1 rounded-lg sm:rounded-xl mb-5 sm:mb-8">
            <div className="bg-black rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2">
              <p className="text-white text-sm sm:text-base font-bold">
                Coming Soon • {workshop.timeInfo} • Limited to {workshop.maxAttendees} participants
              </p>
            </div>
          </div>

          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-5 text-js">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-5 sm:mb-8 text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join this comprehensive workshop to ensure your digital products comply with the
            European Accessibility Act and create inclusive experiences for all users!
          </p>
          ...
          <div className="mt-6 sm:mt-8 bg-gray-800 rounded-lg p-3 sm:p-4 max-w-xl mx-auto">
            ...
            <p className="text-js font-bold mt-2 text-base">
