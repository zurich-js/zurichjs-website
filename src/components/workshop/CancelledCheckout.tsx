      ...
      <div className="flex items-start">
        ...
        <div className="ml-3">
          ...
          <p className="mt-2 text-sm text-yellow-700">
            You cancelled your checkout for {workshopTitle}. We&apos;d appreciate your feedback on
            why you decided not to complete your purchase.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            We&apos;ll use this to follow up about any concerns.
          </p>
        </div>
