...
const adminRoutes = [
  ...
  },
  {
    ...
    description:
      "Accept payments via Payment Links, QR codes, card entry, and simulated Tap to Pay",
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="mb-12">
          ...
          <p className="text-gray-600">
            Welcome to the ZurichJS admin dashboard. Select an organization and choose an admin
            ...
            {adminRoutes.map((route) => (
              ...
              >
                <Link href={route.href}>
                  <div
                    className={`p-6 rounded-lg shadow-md ${route.color} transition-all duration-300 hover:shadow-lg`}
                  >
