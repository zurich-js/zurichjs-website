        ...
        >
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              ZurichJS, operated by the Swiss JavaScript Group (a registered non-profit association
              in Switzerland), is dedicated to providing a harassment-free and inclusive event
            ...
            <p className="mb-4 text-gray-800">
              We do not tolerate harassment of event participants in any form and are committed to
              ensuring a welcoming environment for all attendees.
            </p>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            <h2 className="text-xl font-bold mb-4 text-black">Expected Behavior</h2>
            <p className="mb-4 text-gray-800">We expect all participants to:</p>
            <ul className="list-disc ml-6 mb-4 text-gray-800">
              ...
              <li className="mb-2">
                Alert community organizers if you notice a dangerous situation, someone in distress,
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <ul className="list-disc ml-6 mb-4 text-gray-800">
              ...
              <li className="mb-2">
                ...
                orientation, disability, mental illness, physical appearance, body size, race,
                religion, or socio-economic status.
              </li>
              <li className="mb-2">
                Unwelcome sexual attention, including sexualized comments, jokes, or imagery in
                talks, online communications, or in-person interactions.
              </li>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              If a community member engages in unacceptable behavior, the organizers may take any
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              ...
              please notify an organizer as soon as possible by emailing hello@zurichjs.com or
              speaking directly with any ZurichJS team member at an event.
            </p>
            <p className="mb-4 text-gray-800">
              All complaints will be reviewed and investigated promptly and fairly by the Swiss
              JavaScript Group organizers. All community organizers are obligated to respect the
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              This Code of Conduct applies to all ZurichJS spaces and events, both online and off,
              including meetups, workshops, conferences, social media interactions, and any other
              venues used by our community. It applies to all community participants, including
              attendees, speakers, sponsors, volunteers, and organizers.
            </p>
          </div>
