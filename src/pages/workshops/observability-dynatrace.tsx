    ...
    phases: [
      {
        ...
        duration: "15 minutes",
        description:
          "Understand why observability is critical for modern systems and explore the AstroShop demo application",
        activities: [
      ...
      },
      {
        ...
        duration: "15 minutes",
        description:
          "Learn from common mistakes, establish observability culture, and plan next steps",
        activities: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-7 order-1">
                ...
                <p className="text-lg lg:text-xl text-gray-800 mb-8 lg:mb-10 leading-relaxed max-w-2xl">
                  Beginner-friendly hands-on workshop to master modern observability & monitoring
                  with Dynatrace
                </p>
                    ...
                    {workshop.speakers.length > 1 ? (
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="flex flex-wrap gap-2 justify-center mt-2">
                          <span className="bg-js/10 text-black px-2 py-1 rounded-full text-xs font-semibold border border-js/20">
                            Observability
                          </span>
                          <span className="bg-js/10 text-black px-2 py-1 rounded-full text-xs font-semibold border border-js/20">
                            Dynatrace
              ...
              >
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    <strong>Perfect for beginners!</strong> This hands-on workshop welcomes everyone
                    - no prior observability experience needed. We&apos;ll start from the basics and
                    guide you through the three pillars of observability - metrics, logs, and traces
                    - using the AstroShop application as our playground.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    You&apos;ll learn practical skills like building smart alerts, managing costs
                    effectively, and using tracing to debug issues like a pro. Our expert
                    instructors will walk you through everything step-by-step, making complex
                    concepts easy to understand. By the end, you&apos;ll have the confidence to
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        <p className="text-blue-800 font-medium text-base">
                          <strong>Tool-Agnostic Learning:</strong> While this workshop will
                          primarily use Dynatrace to showcase certain observability practices, most
                          of the learnings will be tool agnostic and applicable to other
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Master metrics, logs, and traces with hands-on exploration using Dynatrace
                          dashboards and correlation techniques.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-black mb-2">
                          Smart Alerting & AI-Powered Detection
                        </h3>
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Configure symptom-based alerts and leverage Dynatrace AI to reduce noise
                          and alert fatigue.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Build efficient observability pipelines with strategic sampling,
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Use OpenTelemetry and Dynatrace tracing to debug latency issues and
        ...
        >
          ...
          <div className="space-y-4">
                ...
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      <span className="text-blue-600 font-bold">Perfect for:</span> Anyone curious
                      about observability - from complete beginners to experienced developers
                      wanting to deepen their knowledge with hands-on practice.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                <span className="font-bold text-lg text-gray-900">
                  Is this workshop really beginner-friendly?
                </span>
                <span
                  className={`ml-4 transition-transform ${openFaq === "beginner" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              {openFaq === "beginner" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  <p className="text-gray-700 mb-4">
                    <strong>Absolutely yes!</strong> This workshop is designed to welcome everyone,
                    regardless of experience level.
                  </p>
                  <div className="space-y-3">
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      <p className="text-sm text-gray-800">
                        <span className="font-bold text-green-700">✓ No Prerequisites:</span> No
                        prior observability experience needed. We start from the fundamentals.
                      </p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      <p className="text-sm text-gray-800">
                        <span className="font-bold text-green-700">✓ Step-by-Step Guidance:</span>{" "}
                        Our expert instructors guide you through each concept with clear
                        explanations.
                      </p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      <p className="text-sm text-gray-800">
                        <span className="font-bold text-green-700">✓ Hands-On Learning:</span> Learn
                        by doing with practical exercises designed for all skill levels.
                      </p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-3 border-l-4 border-green-500">
                      <p className="text-sm text-gray-800">
                        <span className="font-bold text-green-700">✓ Supportive Environment:</span>{" "}
                        Small group size ensures personalized attention and support.
                      </p>
                    </div>
                  </div>
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg mt-4">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">Even better for experienced developers:</span>{" "}
                      If you already have some knowledge, you&apos;ll still gain valuable hands-on
                      experience with Dynatrace and learn advanced techniques!
                    </p>
                  </div>
                </div>
              )}
                ...
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      ...
                      beginner-friendly workshop. Just bring your laptop with internet access and
                      your enthusiasm to learn - we&apos;ll take care of the rest!
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <span
                  className={`ml-4 transition-transform ${openFaq === "included" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-700">
                          2 hours of hands-on training with expert instructors
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Access to Dynatrace environment for practical exercises
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Workshop materials and comprehensive handouts
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Follow-up resources and best practices guide
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Hands-on experience with AstroShop demo application
                        </span>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <span
                  className={`ml-4 transition-transform ${openFaq === "venue" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              {openFaq === "venue" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  <p className="text-gray-700 mb-3">
                    The workshop will be held at <strong>Smallpdf, AG</strong> in Zürich,
                    Switzerland.
                  </p>
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">Venue features:</span> Modern presentation
                      facilities, comfortable seating, reliable WiFi, and refreshments. The venue is
                      easily accessible by public transport. All registered participants will
                      receive detailed directions 1 week before the workshop.
                    </p>
                  </div>
                </div>
              )}
        ...
        >
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-6 max-w-2xl mx-auto border border-white/20">
            ...
            <p className="text-white/90 text-lg mb-4">
              Beginner-friendly hands-on workshop - Learn observability with Dynatrace from expert
              instructors
            </p>
