    ...
    topics: [
      {
        ...
        description:
          "Learn Astro's core concepts and architecture for building high-performance websites.",
        icon: <Rocket className="text-blue-500" size={24} />,
      },
      {
        title: "Content Collections",
        description:
          "Master Astro's powerful content management and type-safe Markdown/MDX systems.",
        icon: <LayoutIcon className="text-purple-500" size={24} />,
      },
      {
        title: "Framework Integrations",
        description:
          "Seamlessly integrate React, Vue, Svelte or other framework components with Astro Islands.",
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Astro Fundamentals</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
                    Learn the core concepts of Astro&apos;s architecture and how it optimizes
                    performance:
                  </p>
                  <ul className="mt-2 space-y-2">
                    ...
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2 text-lg">•</span>
                      <span className="text-gray-700 text-base">
                        Project setup and file-based routing
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-blue-500 mr-2 text-lg">•</span>
                      <span className="text-gray-700 text-base">
                        Building your first Astro components
                      </span>
                    </li>
                  </ul>
                </motion.div>
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Content Collections</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
                  ...
                  <ul className="mt-2 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700 text-base">
                        Type-safe Markdown/MDX content
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-purple-500 mr-2 text-lg">•</span>
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Framework Integrations</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
                  ...
                  <ul className="mt-2 space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700 text-base">
                        Adding React, Vue, or Svelte components
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-green-500 mr-2 text-lg">•</span>
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Advanced Patterns</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed text-base">
            ...
            >
              ...
              <div className="mt-6 bg-yellow-50 border-l-4 border-js p-4 rounded-lg">
                <p className="text-sm sm:text-base font-medium text-gray-800">
                  ...
                  receive code samples and reference materials to continue building with Astro after
                  the workshop.
                </p>
              </div>
            </motion.div>
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <div className="mt-4 sm:mt-6 bg-blue-50 border-l-4 border-blue-500 p-3 sm:p-4 rounded-lg">
                <p className="text-sm sm:text-base font-medium text-gray-800">
                  <span className="text-blue-600 font-bold">Perfect for:</span> Developers looking
                  to build lightning-fast websites with modern tools and minimal JavaScript.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-6 bg-purple-50 border-l-4 border-purple-400 p-4 rounded-lg">
                <p className="text-sm sm:text-base font-medium text-gray-800">
                  Don&apos;t worry if you&apos;re new to Astro! This workshop is designed to take
                  you from zero experience to being able to build complete websites.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              {canceled === "true" ? (
                <CancelledCheckout workshopId="astro-zero-to-hero" workshopTitle={workshop.title} />
              ) : (
                <>
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-lg mb-4">
                    <p className="font-medium text-gray-800">
                      Only {workshop.maxAttendees} spots available for this hands-on technical
                      workshop.
                    </p>
                    <p className="text-xs text-gray-700 mt-1">
                      <strong>Pro tip:</strong> Sign up for a ZurichJS account to get a 20%
                      community discount, or use a coupon code by adding{" "}
                      <code>?coupon=YOUR_CODE</code> to the URL.
                    </p>
                  </div>

                  <p className="mb-4 font-medium text-base">
                    Join our exclusive workshop to learn how to build blazing-fast websites with
                    Astro&apos;s powerful architecture and tooling.
                  </p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Get help, share your projects, and connect with other Astro enthusiasts in our
                  Slack community.
                </p>
                <a
      ...
      <Section variant="black">
        ...
        >
          <div className="inline-block bg-gradient-to-r from-blue-500 to-yellow-500 p-1 rounded-lg sm:rounded-xl mb-5 sm:mb-8">
            <div className="bg-black rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2">
              <p className="text-white text-sm sm:text-base font-bold">
                {workshop.dateInfo} • {workshop.timeInfo} • Limited to {workshop.maxAttendees}{" "}
                participants
              </p>
            </div>
          </div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-5 text-js">
            Become an Astro Expert in Just One Evening! 🚀
          </h2>
          <p className="text-base sm:text-lg md:text-xl mb-5 sm:mb-8 text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join this intensive workshop to learn how Astro helps you build lightning-fast websites
            with less JavaScript. Master the framework that&apos;s transforming modern web
            development!
          </p>
          ...
          <div className="mt-6 sm:mt-8 bg-gray-800 rounded-lg p-3 sm:p-4 max-w-xl mx-auto">
            <p className="text-white text-base">
              Learn everything you need to start building blazing-fast websites with Astro&apos;s
              innovative architecture and advanced features.
            </p>
