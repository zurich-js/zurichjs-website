  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Join the ZurichJS community! Access exclusive events, workshops, and connect with JavaScript developers in Zurich."
        />
      </Head>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div className="text-center py-4">
              ...
              <p className="text-gray-600 mb-6">
                Sign up to access exclusive workshops, events, and connect with JavaScript
                developers in Zurich.
              </p>
              ...
              <div className="space-y-4">
                <SignInButton mode="modal" forceRedirectUrl="/profile">
                  <button className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-medium py-3 text-lg rounded-md shadow-lg hover:shadow-xl transition-all duration-200">
                    Sign Up Now
                  </button>
                </SignInButton>
