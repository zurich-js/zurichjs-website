  ...
  return (
    <div className={`${className}`}>
      ...
      <div className="p-3 overflow-y-auto max-h-32">
        ...
        {activeTab === "questions" && !hasQuestions ? (
          <div className="text-center text-sm text-gray-500 py-2">No questions available</div>
        ) : null}
      </div>
    </div>
  );
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="flex items-center mt-1 text-sm text-gray-600">
              ...
              <span>
                {product.totalFeedback} {product.totalFeedback === 1 ? "review" : "reviews"}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="mb-6">
              <div className="flex justify-between items-start">
                <SentimentGauge score={calculateSentimentScore()} className="w-full" />
              </div>
            </div>
            ...
            {product.insightSummary && (
              <InsightSummary summary={product.insightSummary} className="mb-6" />
            )}

            {/* Contact Info */}
            {product.contactInfo && product.contactInfo.length > 0 && (
              <ContactList contacts={product.contactInfo} className="mb-4" />
            )}
          </div>
