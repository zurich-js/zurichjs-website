            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Your support means the world to us! You&apos;re helping us build an amazing
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          >
            ...
            <p className="text-base sm:text-lg mb-6 sm:mb-8 text-gray-900 leading-relaxed">
              Your love and support allows us to organize amazing meetups, invite world-class
              speakers, provide great food and drinks, and create an inclusive space where
              JavaScript enthusiasts can learn, connect, and grow together.
            </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-xl border-4 border-gray-900">
              <div className="p-4 bg-gray-100 rounded-lg mb-6">
                <h3 className="text-2xl font-bold mb-4 text-center text-gray-900">
                  How Your Love Makes a Difference
                </h3>
              ...
              <div className="text-center">
                <p className="text-gray-900 mb-2">
                  <span className="font-bold">{eventsHosted}+</span> events hosted to date
                </p>
                <p className="text-gray-900">
                  <span className="font-bold">100%</span> volunteer-driven
                </p>
              </div>
            </div>
          </motion.div>
                ...
                >
                  <div className="flex flex-col">
                    ...
                    >
                      ...
                      <ChevronRight
                        className={`inline-block shrink-0 ml-auto ${cancellationDisclosureIsOpen ? "rotate-90" : "rotate-0"} transition-all duration-300`}
                        size={16}
                      />
                    </button>
                    {cancellationDisclosureIsOpen && (
                      ...
                      >
                        ...
                        at hello@zurichjs.com with your registered address and we will promptly
                        unsubscribe you, no questions asked.
                      </motion.p>
                    )}
                  </div>
                </motion.div>
              ...
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border-2 border-transparent hover:border-js-dark touch-manipulation">
                <div className="text-center">
                  ...
                  <h4 className="text-base sm:text-lg font-semibold mb-2 text-gray-900">
                    Get a ZurichJS T-Shirt
                  </h4>
                  <p className="text-sm sm:text-base text-gray-600">
                    Or several, we won&#39;t judge 🙃
                  </p>
                </div>
              </div>
            </Link>
            <a href="mailto:hello@zurichjs.com">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border-2 border-transparent hover:border-js-dark touch-manipulation">
                <div className="text-center">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">
                    Share your ideas and help us improve our events!
                  </p>
                </div>
              </div>
            </a>
            <Link href="/cfv">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border-2 border-transparent hover:border-js-dark touch-manipulation sm:col-span-2 lg:col-span-1">
                <div className="text-center">
                  ...
                  <p className="text-sm sm:text-base text-gray-600">
                    Join the team and help shape the future of ZurichJS!
                  </p>
                </div>
              </div>
            </Link>
        ...
        <Section variant="gray">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-yellow-50 p-8 rounded-lg text-center shadow-inner">
            ...
            <p className="text-gray-600 mb-4">
              Your contribution will help us grow the ZurichJS community.
            </p>
            <button
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          >
            ...
            <p className="text-gray-700">
              Your support goes directly to covering community expenses such as venue rentals,
              refreshments at meetups, speaker support, educational materials, and website
              maintenance. We&apos;re a 100% volunteer-run community!
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              ZurichJS is now registered as a non-profit organization under the Swiss JavaScript
              Group! However, contributions are not yet tax-deductible as we&apos;re still working
              on getting the necessary approvals. We&apos;re actively pursuing this to make it
          ...
          >
            <h3 className="text-xl font-bold mb-2 text-gray-900">
              Can I cancel my monthly support?
            </h3>
            <p className="text-gray-700 mb-3">
              Yes, you can cancel your monthly support at any time. To cancel your monthly recurring
              support, you can{" "}
              <a
                href="mailto:hello@zurichjs.com?subject=Cancel Monthly Support&body=Hi! I'd like to cancel my monthly support. I'm emailing from the same email address I used to subscribe."
              ...
              and email us at hello@zurichjs.com with the same email you subscribed with and
              we&apos;ll cancel it.
            </p>
            <p className="text-gray-700">
              <strong>No questions asked, no explanation needed</strong> - simple, easy, and
              we&apos;re grateful nonetheless! ❤️
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-bold mb-2 text-gray-900">
              My company wants to sponsor. Is this the right place?
            </h3>
            <p className="text-gray-700">
              For larger corporate sponsorships with benefits like logo placement and speaking
              opportunities, please check out our{" "}
              <Link href="/partnerships" className="text-amber-600 hover:underline">
                partnerships page
              </Link>
              . This support page is primarily for individual contributions.
            </p>
          </motion.div>
        </div>
      </Section>
      ...
      <Section variant="black" padding="lg">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Together, we grow the Zurich tech scene ✨
          </h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Every bit of support helps us create a thriving community where developers grow,
