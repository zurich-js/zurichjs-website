    ...
    <Layout>
      <SEO
        ...
        openGraph={{
          title: "Contact ZurichJS | JavaScript Community in Zurich",
          description:
            "Get in touch with the ZurichJS team - we're happy to answer your questions about our JavaScript community in Zurich.",
        ...
        <Section variant="gradient">
          ...
          >
            ...
            <p className="text-xl mb-6 text-gray-900 max-w-3xl mx-auto">
              Have questions about ZurichJS? Want to speak at one of our events? Looking to sponsor
              or collaborate? We&apos;d love to hear from you!
            </p>
          </motion.div>
        </Section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-gray-900">
                How can I speak at a ZurichJS event?
              </h3>
              <p className="text-gray-700">
                We&apos;re always looking for speakers! You can apply directly through our Call for
                Papers{" "}
                <Link href="/cfp" className="text-blue-700 hover:underline">
                  here
                </Link>
                . First-time speakers are absolutely welcome - we can help train you and provide
                guidance on public speaking. If you have questions about the process, feel free to
                reach out to us on{" "}
                <a
                  href="https://www.linkedin.com/company/zurichjs"
                  target="_blank"
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-gray-900">
                Can my company sponsor or host a ZurichJS event?
              </h3>
              <p className="text-gray-700">
                Absolutely! We&apos;re always looking for venues and sponsors. Please contact us to
                discuss how we can collaborate to create an amazing event for the JavaScript
                community. Check out our{" "}
                <Link href="/partnerships" className="text-blue-700 hover:underline">
                  partnerships page
                </Link>{" "}
                to find out more.
              </p>
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-gray-900">
                How can I get involved with the ZurichJS community?
              </h3>
              <p className="text-gray-700">
                Start by joining our Meetup group and attending events! Bring your energy and
                enthusiasm to our meetups. If you want to volunteer and help organize events, create
                content, or contribute in other ways, reach out to us on{" "}
                <a
                  href="https://www.linkedin.com/company/zurichjs"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-gray-900">
                Are ZurichJS events suitable for beginners?
              </h3>
              <p className="text-gray-700">
                Yes! We strive to make our events welcoming and valuable for JavaScript developers
                of all skill levels. Our topics are carefully selected to appeal to both beginners
                and advanced developers, and we ensure that content is accessible regardless of your
                experience level.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-lg font-bold mb-2 text-gray-900">
                Do you cover travel and accommodation for speakers?
              </h3>
              <p className="text-gray-700">
                Currently, as a community-run event, we don&apos;t have the resources to cover
                travel and accommodation for speakers. However, this is something we&apos;re
                actively working on with potential sponsors to make speaking opportunities more
        ...
        <Section variant="white">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              We&apos;re excited to hear from you and welcome you to our JavaScript community in
              Zurich.
            </p>
