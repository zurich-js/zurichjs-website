    ...
    <Layout>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            ...
            <div className="bg-white bg-opacity-80 p-5 rounded-lg shadow-sm mb-6">
              ...
              <p className="text-gray-800 leading-relaxed">{workshop.description}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button onClick={scrollToRegistration} className="bg-black text-js hover:bg-gray-800">
                Register Now
              </Button>
            </div>
          </motion.div>
          ...
          >
            <div className="sticky top-24 rounded-xl overflow-hidden shadow-xl bg-white p-6 border-l-4 border-purple-600">
              ...
              <div className="mt-6 pt-5 border-t border-gray-200">
                ...
                <p className="text-sm italic text-gray-600 bg-purple-50 p-3 rounded-lg">
                  &quot;Join me to explore practical strategies for building performant and
                  resilient React applications that stand up to real-world challenges.&quot;
                </p>
          ...
          <div className="lg:w-2/3">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Identify common performance issues and learn when to optimize and when it might
                    be over-engineering. We&apos;ll explore practical examples of:
                  </p>
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Explore strategies to build applications that can handle unexpected issues
                    gracefully. Learn about:
                  </p>
                  <ul className="mt-2 space-y-1">
                    <li className="flex items-start">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Understand how React updates the DOM and optimize your components for better
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Component Architecture</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                    Learn best practices for structuring your components for maintainability and
                    performance:
                  </p>
                  <ul className="mt-2 space-y-1">
                    <li className="flex items-start">
                ...
                >
                  <div className="flex items-center mb-3">
                    ...
                    <h3 className="text-xl font-bold ml-3 text-gray-800">Data Fetching at Scale</h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                    Explore efficient data fetching strategies using React Query for large-scale
                    applications:
                  </p>
                  <ul className="mt-2 space-y-1">
                    <li className="flex items-start">
                ...
                >
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Learn how to monitor your application&apos;s health and implement feature flags
            ...
            >
              ...
              <div className="mt-6 bg-yellow-50 border-l-4 border-js p-4 rounded-lg">
                <p className="text-sm font-medium text-gray-800">
                  <span className="text-yellow-600 font-bold">Note:</span> All participants will
                  receive the full workshop materials including code samples, slides, and
                  cheatsheets to review at their own pace after the session.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-6 bg-purple-50 border-l-4 border-purple-500 p-4 rounded-lg">
                <p className="text-sm font-medium text-gray-800">
                  <span className="text-purple-600 font-bold">Perfect for:</span> Teams looking to
                  implement real-world performance optimization strategies without over-engineering
                  their solutions.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                {workshop.prerequisites.map((prerequisite, index) => (
                  <div key={index} className="flex items-center bg-blue-50 p-4 rounded-lg">
                    ...
                    {index === 1 && (
                      <MessageSquare className="text-blue-600 mr-3 flex-shrink-0" size={20} />
                    )}
                    {index === 2 && (
                      <LayoutTemplate className="text-blue-600 mr-3 flex-shrink-0" size={20} />
                    )}
                    {index === 3 && (
                      <BookOpen className="text-blue-600 mr-3 flex-shrink-0" size={20} />
                    )}
              ...
              <div className="mt-6 bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                <p className="text-sm font-medium text-gray-800">
                  <span className="text-blue-600 font-bold">Pro tip:</span> For the best experience,
                  we recommend reviewing the React docs on hooks and performance optimization before
                  the workshop.
                </p>
              </div>
            </motion.div>
          ...
          <div className="lg:w-1/3">
            ...
            >
              ...
              <p className="mb-4 font-medium">
                Join our exclusive workshop for practical React performance techniques you can apply
              ...
              <div className="mt-4">
                <div className="bg-indigo-50 p-4 rounded-lg mb-3">
                  <p className="text-sm text-gray-800">
                    <span className="font-bold text-indigo-700">Areas of Expertise:</span> React
                    Performance, Frontend Architecture, Engineering Management, Scale & Resilience
                  </p>
                </div>
                <p className="text-sm text-gray-700">
                  Faris comes from a boot camp and self-taught background, having contributed to
                  open-source projects in his spare time. His passion for technology extends beyond
                  coding; he loves consulting on web projects and aiding start-ups with technical
                  strategy.
                </p>
                <p className="text-sm text-gray-700 mt-2">
                  Having worked in many industries, including Connected TV, Fintech, Digital Asset
                  Management, SaaS, and Fitness, Faris has found his niche in start-ups. Some of his
                  previous work has revolved around building large-scale full-stack solutions for
                  notable companies like Fiit, Discovery, GCN, Eurosport, Navro (formerly Paytrix)
                  and SmallPDF, serving millions of users globally.
                </p>
              </div>
            </motion.div>
              ...
              <div className="space-y-5">
                <div className="border-b border-gray-100 pb-3">
                  ...
                  <p className="text-gray-700">
                    This workshop is designed for developers with intermediate JavaScript knowledge
                    and some experience with React. If you&apos;re a complete beginner, we recommend
                    gaining some basic React experience first.
                  </p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-3">
                  ...
                  <p className="text-gray-700">
                    Please bring a laptop with the latest LTS version of Node.js installed. Before
                    the workshop, we&apos;ll email you setup instructions for the coding exercises.
                  </p>
                </div>
                ...
                <div className="border-b border-gray-100 pb-3">
                  ...
                  <p className="text-gray-700">
                    This is a hands-on workshop, so we recommend attending in person for the best
                    experience. Workshop materials will be provided to all participants, but the
                    session itself won&apos;t be recorded.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    This is a foundations workshop organized by ZurichJS. While it complements the
                    conference content, the workshop ticket is sold separately from conference
                    tickets.
                  </p>
                </div>
              </div>
      ...
      <Section variant="black">
        ...
        >
          ...
          <h2 className="text-4xl font-bold mb-5 text-js">
          ...
          <div className="mt-8 bg-gray-800 rounded-lg p-4 max-w-xl mx-auto">
            <p className="text-white text-sm">
              &quot;This workshop focuses on actionable techniques you can implement immediately in
              your projects. No fluff, just practical performance strategies that work in
              production.&quot;
            </p>
