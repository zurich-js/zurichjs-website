                            ...
                            >
                                <div className="relative rounded-lg overflow-hidden shadow-lg bg-white p-6">
                                    ...
                                    <div className="mt-6 pt-4 border-t border-gray-200">
                                        ...
                                        <p className="text-sm italic text-gray-600">&quot;Join me to explore the power and elegance of Vue.js and learn how to build modern, reactive web applications with confidence.&quot;</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row gap-10">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        >
                                            ...
                                            <p className="text-gray-600">
                                                Understand the fundamentals of Vue 3, including the Composition API, reactivity system, and component lifecycle.
                                            </p>
                                        </motion.div>
                            ...
                            <div className="lg:w-1/3">
                                ...
                                >
                                    ...
                                    <p className="mb-4">
                                        This workshop is designed to provide a comprehensive introduction to Vue.js through a mix of theory and hands-on practice. You&apos;ll build a complete Vue application from scratch during the session.
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="mt-4">
                                        <p className="text-sm text-gray-700">
                                            Aleksej is a passionate frontend developer with extensive experience in Vue.js and modern web technologies. He has been working with Vue since its early versions and has contributed to numerous production applications.
                                        </p>
                                        <p className="text-sm text-gray-700 mt-2">
                                            With a background in both startups and enterprise environments, Aleksej brings practical insights into building scalable and maintainable Vue applications. He is known for his ability to explain complex concepts in an accessible way, making him an ideal instructor for developers at all skill levels.
                                        </p>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-gray-700">Yes, this workshop is designed for developers with basic JavaScript knowledge who want to learn Vue.js. No prior Vue experience is required.</p>
                                        </div>

                                        <div>
                                            <p className="font-semibold">I know React/Angular. Will this workshop be useful for me?</p>
                                            <p className="text-gray-700">Absolutely! We&apos;ll cover Vue&apos;s unique approach and highlight similarities and differences with other frameworks to help you leverage your existing knowledge.</p>
                                        </div>

                                        <div>
                                            <p className="font-semibold">Do I need to bring my own laptop?</p>
                                            <p className="text-gray-700">Yes, please bring a laptop with the latest LTS version of Node.js installed to participate in the hands-on coding exercises.</p>
                                        </div>
