...
export default function ReactArchitectureWorkshopPage({ speakers }: WorkshopPageProps) {
  ...
  const workshop: WorkshopDetails = {
    ...
    price: "250 CHF",
    description:
      "An intensive 3-hour crash course teaching you to build React applications that survive production. Master essential architecture patterns, performance optimization, and resilience engineering through rapid-fire lessons, hands-on exercises, and real-world examples. Perfect for developers who want to level up their React skills quickly and efficiently.",
    maxAttendees: 15,
    speakers: speakers,
    topics: [
      {
    ...
    phases: [
      ...
      },
      {
        ...
        duration: "35 minutes",
        description:
          "Deep dive into Virtual DOM, diffing algorithms, and performance optimization tools",
        activities: [
      ...
      },
      {
        ...
        duration: "25 minutes",
        description:
          "Rapid-fire discussions on real-world scenarios and learn DORA metrics for high-performing teams",
        activities: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-7 order-1">
                ...
                <p className="text-lg lg:text-xl text-gray-800 mb-8 lg:mb-10 leading-relaxed max-w-2xl">
                  Intensive crash course covering production-ready patterns, performance
              ...
              >
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    This intensive 3-hour crash course is designed for developers who want to
                    rapidly level up their React architecture skills. We&apos;ll cover essential
                    production-ready patterns through rapid-fire lessons, hands-on exercises, and
                    real-world examples.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed">
                    You&apos;ll walk away with immediately applicable knowledge of component
                    architecture, performance optimization, resilience patterns, and deployment
                    confidence techniques. Perfect for busy developers who want maximum learning
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div className="lg:col-span-1">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-lg text-green-900 font-bold">Here: CHF 250 ✨</p>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      <div className="text-center lg:text-left mb-4">
                        ...
                        <p className="text-xs text-green-700">
                          From <strong>CityJS Athens</strong>, <strong>ReactJS Day</strong>, and{" "}
                          <strong>CityJS London</strong>
                        </p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-700 italic mb-2">
                                ...
                                <strong>highlight of the conference</strong> for me. Very
                                informative.&quot;
                              </p>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm border border-green-100">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-700 italic mb-2">
                                &quot;The tutor was <strong>fun, easy going</strong> and he knew his
                                subject well.&quot;
                              </p>
                              <div className="flex items-center justify-between">
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm border border-green-100 md:col-span-2 lg:col-span-1 xl:col-span-2">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-gray-700 italic mb-2">
                                &quot;The <strong>practical examples</strong> with a well thought
                                repo&quot;
                              </p>
                              <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Master Atomic Design principles and granular components that improve
                          reconciliation and minimize re-renders by design.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Understand the Virtual DOM, diffing algorithms, and tools like React.memo,
                          useMemo, and useCallback for optimal performance.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Implement Circuit Breaker, Retry patterns, and failure isolation with
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                          Build observability with Sentry, implement feature flags, and use DORA
                          metrics for high-performing frontend teams.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      ...
                      React applications who wants to move beyond basic development and learn
                ...
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      ...
                      workshop with code exercises. Bring your laptop with Node.js installed and
                      come ready for interactive learning!
                    </p>
                  </div>
                </div>
              )}
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-700">
                          3 hours of intensive hands-on training with expert instructors
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Complete workshop repository with starter code and reference solutions
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Hands-on exercises covering all major topics
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Workshop materials and comprehensive resources
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Access to instructor support during and after the workshop
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              {openFaq === "venue" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  <p className="text-gray-700 mb-3">
                    The workshop will be held at <strong>Orbiz Josef</strong> in{" "}
                    <strong>Zürich, Switzerland</strong>.
                  </p>
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">Venue features:</span> Modern presentation
                      facilities, comfortable seating, reliable WiFi, power outlets for laptops, and
                      refreshments. The venue is easily accessible by public transport. All
                      registered participants will receive detailed venue information and directions
