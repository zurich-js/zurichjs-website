    ...
    <Section variant="black" padding="lg" className="flex justify-center">
      ...
      >
        ...
        <p className="text-xl mb-8">
          Calling all JavaScript enthusiasts! Whether you&apos;re coding in React, Vue, Angular, or
          vanilla JS – we&apos;ve created an incredible community just for you! Let&apos;s build
        ...
        <Button href={buttonUrl} variant="secondary" size="lg" className="w-fit mx-auto block">
      ...
      {showNewsletter && (
        ...
        >
          ...
          <p className="mb-6">
            Never miss a ZurichJS gathering! Subscribe to our newsletter for exclusive updates on
            upcoming meetups, special guests, and the latest JavaScript magic happening in Zurich!
            🌟
          </p>
          <Newsletter />
