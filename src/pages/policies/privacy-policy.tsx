        ...
        >
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              The Swiss JavaScript Group, a registered non-profit association (Verein) in
              Switzerland, operating ZurichJS, respects your privacy and is committed to protecting
              your personal data. This privacy policy will inform you about how we look after your
              personal data when you visit our website and attend our events, and tell you about
              your privacy rights.
            </p>
            <p className="mb-4 text-gray-800">
              For the purposes of this privacy policy, &quot;we,&quot; &quot;us,&quot; and
              &quot;our&quot; refer to the Swiss JavaScript Group and its ZurichJS operations.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <ul className="list-disc ml-6 mb-4 text-gray-800">
              ...
              <li className="mb-2">
                <strong>Event Data</strong> includes details about your registration and attendance
                at our events.
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <ul className="list-disc ml-6 mb-4 text-gray-800">
              ...
              <li className="mb-2">
                To provide you with information about upcoming events and content that may be of
                interest to you.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                To improve our website, products/services, marketing, and your experience.
              </li>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              ...
              disclosed. We limit access to your personal data to those who have a business need to
              know.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-js mb-8">
            ...
            <p className="mb-4 text-gray-800">
              As a registered non-profit association in Switzerland, we are committed to handling
              your data in accordance with Swiss data protection laws and European GDPR standards.
            </p>
          </div>
