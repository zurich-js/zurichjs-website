...
export default function LandingHero({ upcomingEvents, upcomingWorkshops }: LandingHeroProps) {
  ...
  const nextWorkshop =
    upcomingWorkshops && upcomingWorkshops.length > 0 ? upcomingWorkshops[0] : null;
  ...
  return (
    <section className="w-full py-12 lg:py-24" style={{ backgroundColor: COLORS.pageYellow }}>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              {/* ZurichJS Logo Mark */}
              <h1 className="sr-only">Zürich JS</h1>
              <svg
                className="block md:hidden w-auto h-10 sm:h-12 xl:h-14 2xl:h-16 flex-shrink-0"
                viewBox="0 0 286 40"
                fill="none"
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Workshop Card */}
              {nextWorkshop && (
                <WorkshopCard workshop={nextWorkshop} onWorkshopClick={handleWorkshopClick} />
              )}
            </div>
...
function ConferencePromoCard({ onConfClick }: { onConfClick: () => void }) {
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      ...
      {/* Title */}
      <h3 className="text-2xl font-bold text-black mb-2">ZurichJS Conf</h3>
...
function EventCard({
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      ...
      {/* Title */}
      <h3 className="text-xl lg:text-2xl font-bold text-black mb-4">{event.title}</h3>
...
function WorkshopCard({
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
      ...
      {/* Title */}
      <h3 className="text-xl font-bold text-black mb-4">{workshop.title}</h3>
