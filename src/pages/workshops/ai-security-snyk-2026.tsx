...
import { aiSecuritySnykTickets } from "@/components/workshop/aiSecuritySnykTickets";
...
function HorizontalTimeline({ seatsRemaining }: { seatsRemaining: number }) {
  const now = new Date();
  const earlyBirdEnd = new Date("2026-01-23");
  const workshopDate = new Date("2026-03-23");

  // Calculate early bird seats remaining
  const soldTickets = 30 - seatsRemaining;
  const earlyBirdSoldOut = soldTickets >= 15; // Assuming 15 early bird tickets

  const milestones = [
    {
      name: "Early Bird Pricing",
      date: "Until Jan 23rd, 2026",
      price: "CHF 95",
      ...
      icon: "🐦",
      extraInfo:
        !earlyBirdSoldOut && now < earlyBirdEnd
          ? `${Math.max(0, 15 - soldTickets)} early bird seats left`
          : null,
    },
    {
      name: "Standard Pricing",
      date: "Jan 23rd - Mar 23rd, 2026",
      price: "CHF 125",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {milestones.map((milestone, index) => (
            <div key={milestone.name} className="relative">
              ...
              {/* Milestone card */}
              <div
                className={`${milestone.bgColor} rounded-xl p-4 border-2 ${
                  index === currentMilestone ? `border-zurich shadow-lg` : "border-gray-200"
                }`}
              >
...
function CountdownTimer({ seatsRemaining }: { seatsRemaining: number }) {
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      const earlyBirdEnd = new Date("2026-01-23T23:59:59").getTime();
      const workshopStart = new Date("2026-03-23T15:30:00").getTime();

      // Calculate sold tickets and early bird seats left
      const totalSeats = 30;
      const soldTickets = totalSeats - seatsRemaining;
      const earlyBirdSoldOut = soldTickets >= 15;
  ...
  const countdownLabel =
    !earlyBirdSoldOut && now < earlyBirdEnd ? "Early Bird Ends In:" : "Workshop Starts In:";
  ...
  return (
    <div className="text-center">
      <div className="text-xs font-medium text-white mb-1">{countdownLabel}</div>
      <div className="flex gap-2 sm:gap-4">
        {[
          ...
          <div
            key={unit.label}
            className="bg-white/90 backdrop-blur rounded-lg px-2 py-1 sm:px-3 sm:py-2 text-center min-w-[3rem] sm:min-w-[4rem]"
          >
...
export default function AISecuritySnykWorkshopPage({ speakers }: WorkshopPageProps) {
  const [isClient, setIsClient] = useState(false);
  ...
  const workshop: WorkshopDetails = {
    id: "ai-security-snyk-2026",
    title: "AI Security Certificate Workshop with Snyk",
    subtitle: "Hands-On Sessions: Build, Secure & Exploit LLM Applications",
    dateInfo: "March 23, 2026",
    timeInfo: "15:30 - 18:00 (2.5 hours)",
    locationInfo: "Venue TBA, Zürich",
    price: "95 CHF (Early Bird) / 125 CHF (Standard)",
    description:
      "Join Liran Tal, Developer Advocate at Snyk and renowned security expert, for an intensive hands-on workshop on AI security. Learn how to build secure AI-native applications, work with MCP servers, and protect LLM-powered systems from emerging threats. Walk away with a Snyk AI Security Certificate and practical skills you can apply immediately.",
    maxAttendees: 30,
    speakers: speakers,
    topics: [
      {
        ...
        description:
          "Introduction to building modern AI-native applications and understanding their unique security challenges.",
        icon: <Terminal className="text-blue-600" size={24} />,
      },
      {
        title: "Building MCP Servers",
        description:
          "Hands-on experience creating and deploying Model Context Protocol (MCP) servers for AI applications.",
        icon: <Shield className="text-amber-600" size={24} />,
      },
      {
        title: "MCP Security Deep Dive",
        description:
          "Learn advanced security patterns and best practices for securing MCP implementations.",
        icon: <Lock className="text-green-600" size={24} />,
      },
      {
        title: "Exploiting LLM Applications",
        description:
          "Understand common vulnerabilities in LLM-powered applications and how to defend against them.",
        icon: <AlertTriangle className="text-purple-600" size={24} />,
      },
      {
        title: "AI Security Best Practices",
        description:
          "Comprehensive best practices for developing secure, production-ready AI-native applications.",
        icon: <CheckCircle className="text-red-600" size={24} />,
      },
    ],
    takeaways: [
      "Snyk AI Security Certificate upon completion",
      "Hands-on experience building and securing MCP servers",
      "Understanding of common LLM application vulnerabilities",
      "Practical techniques for exploiting and defending AI systems",
      "Security best practices for AI-native development",
      "Real-world examples and case studies from production systems",
      "Access to exclusive Snyk AI security resources and tools",
      "Networking with security professionals and AI developers",
    ],
    targetAudience: [
      "Developers building AI-powered applications",
      "Security engineers focusing on AI/ML systems",
      "DevSecOps professionals integrating AI security",
      "Technical leads overseeing AI product development",
      "Anyone interested in practical AI security skills",
    ],
    prerequisites: [
      "Basic understanding of software development",
      "Familiarity with API concepts and REST",
      "Some experience with command-line tools",
      "Basic knowledge of security concepts is helpful but not required",
      "Laptop with Node.js and a code editor installed",
    ],
    phases: [
      {
        title: "Introduction to AI-Native Applications",
        duration: "20 minutes",
        description:
          "Overview of AI-native architecture, common patterns, and unique security considerations",
        activities: [
          "Understanding AI-native application architecture",
          "Identifying security challenges in AI systems",
          "Review of the AI security landscape in 2026",
          "Introduction to workshop goals and outcomes",
        ],
        concepts: [
          "AI-native vs traditional applications",
      ...
      {
        title: "How to Build and Use an MCP Server",
        duration: "30 minutes",
        description: "Hands-on session building a Model Context Protocol server from scratch",
        activities: [
      ...
      },
      {
        title: "MCP Security Deep Dive",
        duration: "30 minutes",
        description: "Advanced security patterns and techniques for protecting MCP implementations",
        activities: [
      ...
      {
        title: "Exploiting and Securing LLM-Powered Applications",
        duration: "40 minutes",
        description: "Practical demonstrations of common LLM vulnerabilities and their mitigations",
        activities: [
          "Demonstrating prompt injection attacks",
          "Exploring data leakage vulnerabilities",
          "Testing for model manipulation",
      ...
      {
        title: "Best Practices & Certificate Award",
        duration: "30 minutes",
        description: "Comprehensive review of AI security best practices and certificate ceremony",
        activities: [
          "Review of security best practices checklist",
          "Discussion of real-world case studies",
          "Q&A with Liran Tal",
          "Snyk AI Security Certificate award",
        ],
        concepts: [
  ...
  const scrollToDetails = useCallback(() => {
    ...
    if (whatYoullLearnSection) {
      ...
      const elementPosition =
        whatYoullLearnSection.getBoundingClientRect().top + window.pageYOffset;
  ...
  const shareWorkshop = async () => {
    ...
    const shareText = `Join me at ${workshop.title} with ZurichJS & Snyk!`;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
              ...
              <div className="lg:col-span-7 order-1">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 lg:mb-10">
                  ...
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-black/10 flex flex-col justify-center items-center text-center min-h-[80px]">
                    <div className="text-sm lg:text-base font-bold text-black mb-1">
                      15:30-18:00
                    </div>
                    <div className="text-xs lg:text-sm text-gray-600 font-medium">2.5 hours</div>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-black/10 flex flex-col justify-center items-center text-center min-h-[80px]">
                    <div className="text-sm lg:text-base font-bold text-blue-600 mb-1">
                      Venue TBA
                    </div>
                    <div className="text-xs lg:text-sm text-gray-600 font-medium">Zürich</div>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-black/10 flex flex-col justify-center items-center text-center min-h-[80px]">
                    <div className="text-sm lg:text-base font-bold text-red-600 mb-1">
                      {seatsRemaining} seats left
                    </div>
                    <div className="text-xs lg:text-sm text-gray-600 font-medium">
                      of {workshop.maxAttendees}
                    </div>
                  </div>
                </div>
                ...
                <div className="lg:hidden">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                      ...
                      <span className="text-sm font-medium text-gray-800">MCP Security</span>
                    </div>
                    <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                      <div className="text-2xl">⚡</div>
                      <span className="text-sm font-medium text-gray-800">Build MCP Servers</span>
                    </div>
                    <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                    ...
                    <div className="flex items-center gap-3 bg-white/50 rounded-lg p-3">
                      <div className="text-2xl">✅</div>
                      <span className="text-sm font-medium text-gray-800">Get Certified</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    {workshop.speakers.map((speaker) => (
                      <div key={speaker.id}>
                        ...
                        <div className="flex flex-wrap gap-2 justify-center mb-6">
                          <span className="bg-js/10 text-black px-3 py-1 rounded-full text-xs font-semibold border border-js/20">
                            Security Expert
                          </span>
                          <span className="bg-js/10 text-black px-3 py-1 rounded-full text-xs font-semibold border border-js/20">
                            AI Security
                        ...
                        <div className="text-center">
                          <div className="inline-flex items-center gap-2 bg-gray-50 px-4 py-2 rounded-lg border border-gray-200">
                            <div className="w-6 h-6 bg-gradient-to-br from-purple-600 to-purple-700 rounded"></div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                <div className="text-center">
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-black/10 hover:shadow-md transition-shadow duration-200">
                    ...
                    <h4 className="font-bold text-black mb-2">MCP Security</h4>
                    <p className="text-sm text-gray-600">Deep dive into securing MCP servers</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-black/10 hover:shadow-md transition-shadow duration-200">
                    <div className="text-4xl mb-4">⚡</div>
                    <h4 className="font-bold text-black mb-2">Build MCP Servers</h4>
                    <p className="text-sm text-gray-600">Hands-on MCP server development</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-black/10 hover:shadow-md transition-shadow duration-200">
                    <div className="text-4xl mb-4">🛡️</div>
                    <h4 className="font-bold text-black mb-2">Exploit & Defend</h4>
                    <p className="text-sm text-gray-600">Learn to attack and protect LLM apps</p>
                  </div>
                </div>
                <div className="text-center">
                  <div className="bg-white rounded-xl p-6 shadow-sm border border-black/10 hover:shadow-md transition-shadow duration-200">
                    <div className="text-4xl mb-4">✅</div>
                    <h4 className="font-bold text-black mb-2">Get Certified</h4>
                    <p className="text-sm text-gray-600">Earn Snyk AI Security Certificate</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              >
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    Join <strong>Liran Tal</strong>, Developer Advocate at Snyk and renowned
                    security expert, for an intensive hands-on workshop on AI security. This
                    workshop will take you through the complete lifecycle of building, securing, and
                    testing AI-native applications with a focus on practical, real-world scenarios.
                  </p>
                  <p className="text-gray-700 text-lg leading-relaxed">
                    You&apos;ll learn how to build secure Model Context Protocol (MCP) servers,
                    understand common vulnerabilities in LLM-powered applications, and implement
                    best practices for production-ready AI systems. Walk away with a{" "}
                    <strong>Snyk AI Security Certificate</strong> and practical skills you can apply
              ...
              <motion.div
                ...
                className="mb-12"
              >
                <h2 className="text-3xl lg:text-4xl font-black text-black mb-8">Key Takeaways</h2>
              ...
              <div className="lg:sticky lg:top-24">
                ...
                >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-green-700 mt-1">
                            Sign in to unlock your <strong>20% community discount</strong> on
                            workshop tickets
                          </p>
                        </div>
                        <Link
                          href="/workshops/ai-security-snyk-2026?signup=true"
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div
                      className={`${isSoldOut ? "bg-red-500" : "bg-zurich"} text-white px-4 py-2`}
                    >
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <span
                  className={`ml-4 transition-transform ${openFaq === "audience" ? "rotate-180" : ""}`}
                >
                ...
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      <span className="text-blue-600 font-bold">Perfect for:</span> Anyone building
                      or securing AI applications who wants hands-on experience with the latest
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <span
                  className={`ml-4 transition-transform ${openFaq === "prerequisites" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              {openFaq === "prerequisites" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-800">
                      <span className="text-blue-600 font-bold">Note:</span> This is a hands-on
                      workshop. Bring your laptop with Node.js installed and come ready to code!
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              <button
                className="w-full flex justify-between items-center px-6 py-4 text-left focus:outline-none hover:bg-gray-50 transition-colors"
                onClick={() => setOpenFaq(openFaq === "certificate" ? null : "certificate")}
                aria-expanded={openFaq === "certificate"}
              >
                <span className="font-bold text-lg text-gray-900">
                  What&apos;s included with the certificate?
                </span>
                <span
                  className={`ml-4 transition-transform ${openFaq === "certificate" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-700">
                          Official Snyk AI Security Certificate of completion
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Verifiable digital credential for LinkedIn and resumes
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Access to exclusive Snyk AI security resources
                        </span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2">✓</span>
                        <span className="text-gray-700">
                          Ongoing updates on AI security best practices
                        </span>
                      </li>
                    </ul>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                <span className="font-bold text-lg text-gray-900">
                  Are there team discounts and invoicing available?
                </span>
                <span
                  className={`ml-4 transition-transform ${openFaq === "discounts" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              {openFaq === "discounts" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  <p className="text-gray-700 mb-4">
                    Yes! We offer team discounts and can provide invoicing for corporate bookings:
                  </p>
                  ...
                  <div className="mt-4 bg-blue-50 p-3 rounded-lg">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">
                        Need invoicing or have questions about team bookings?
                      </span>{" "}
                      Please reach out to us at{" "}
                      <a href="mailto:hello@zurichjs.com" className="text-zurich underline">
                        hello@zurichjs.com
                      </a>{" "}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              >
                ...
                <span
                  className={`ml-4 transition-transform ${openFaq === "refund" ? "rotate-180" : ""}`}
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              {openFaq === "refund" && (
                <div className="px-6 pb-6 animate-fadeIn">
                  <p className="text-gray-700 mb-4">
                    Please review our complete refund policy for all terms and conditions regarding
                    workshop cancellations and refunds.
                  </p>
                  <div className="bg-blue-50 border-l-4 border-zurich p-4 rounded-lg">
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold text-zurich">Full details:</span>{" "}
                      <Link
                        href="/policies/refund-policy"
                        className="text-zurich underline hover:text-zurich/80 transition-colors"
                      >
        ...
        >
          ...
          <div className="bg-white/10 backdrop-blur rounded-xl p-6 mb-6 max-w-2xl mx-auto border border-white/20">
            ...
            <p className="text-white/90 text-lg mb-4">
              Master AI security with hands-on labs and earn your Snyk certificate
            </p>
        ...
        speakers: [
          {
            id: "liran-tal",
            name: "Liran Tal",
            title: "Developer Advocate at Snyk & Security Expert",
            image: "/images/speakers/liran-tal.jpg",
            bio: "Liran Tal is a Developer Advocate at Snyk and a renowned security expert specializing in AI security, DevSecOps, and application security. He is a prolific open source contributor, author, and international speaker on security topics.",
          },
        ],
      },
      revalidate: 60,
