...
export default function About({ teamMembers, milestones, stats, pastEvents }: AboutPageProps) {
  ...
  const eventStats = useMemo(() => {
    ...
    const highestAttendanceEvent = sortedEvents.reduce(
      (max, event) => (event.attendees > max.attendees ? event : max),
      sortedEvents[0],
    );
    ...
    <Layout>
      <SEO
        ...
        openGraph={{
          title: "About ZurichJS | JavaScript Community in Zurich",
          description:
            "Learn about ZurichJS - the vibrant JavaScript community in Zurich bringing together developers, enthusiasts and tech lovers since 2024.",
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            ...
            <p className="text-lg mb-6 text-gray-900">
              We&apos;re a thriving community of JS enthusiasts who love to code, learn, and
              connect. From React wizards to Node.js ninjas, TypeScript pros to vanilla JS lovers –
              everyone building with JavaScript has a home here!
            </p>
            <p className="text-sm mb-8 text-gray-700 bg-white/20 p-4 rounded-lg">
              <strong>Legal Note:</strong> ZurichJS is part of the Swiss JavaScript Group, a
              non-profit association (Verein) registered in Switzerland, dedicated to fostering
              JavaScript communities across the country.
            </p>
          </motion.div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-lg">
              ...
              <div className="text-center mt-4 mb-2">
                <span className="text-sm text-gray-700">
                  Our amazing community at a recent meetup! 🎉
                </span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p className="text-2xl font-medium mt-6 mb-6 text-gray-900">
              &quot;To create an inclusive, vibrant space where JavaScript developers of all levels
              can learn, share, and grow together, fostering innovation and friendship in our tech
              community.&quot;
            </p>
            <p className="text-gray-700 italic">— The ZurichJS Team</p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          ...
          >
            ...
            <p className="text-gray-700">
              We believe in freely sharing our JavaScript expertise to lift everyone up! From
              beginner tips to advanced techniques, we learn together.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              At ZurichJS, it&apos;s not just about code – it&apos;s about the amazing people! We
              create meaningful connections that last beyond our meetups.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              We&apos;re passionate about exploring new JavaScript frontiers together, from
              cutting-edge frameworks to revolutionary tools and techniques.
            </p>
          </motion.div>
        </div>
      </Section>
      ...
      <Section variant="white">
        ...
        >
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Understanding the structure behind ZurichJS and our commitment to the Swiss JavaScript
            community
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg mb-4 text-gray-700">
              ZurichJS operates under the <strong>Swiss JavaScript Group</strong>, a registered
              non-profit association (Verein) in Switzerland. This legal structure ensures our
              commitment to fostering JavaScript communities across Switzerland while maintaining
              transparency and accountability to our members and the broader developer community.
            </p>
            <p className="text-lg mb-4 text-gray-700">
              The Swiss JavaScript Group serves as the umbrella organization for JavaScript meetups
              and events throughout Switzerland, with ZurichJS being our flagship community in the
              Zurich area. This structure allows us to:
            </p>
            <ul className="list-disc ml-6 mb-4 text-gray-700">
              <li className="mb-2">
                Operate as a recognized non-profit organization under Swiss law
              </li>
              <li className="mb-2">Maintain transparent financial operations and governance</li>
              <li className="mb-2">
                Collaborate with other JavaScript communities across Switzerland
              </li>
              <li className="mb-2">Provide legal protection and proper insurance for our events</li>
              <li className="mb-2">
                Ensure compliance with Swiss regulations and data protection laws
              </li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg mb-4 text-gray-700">
              As a non-profit association, our primary mission is to serve the JavaScript community,
              not to generate profit. All revenue from events and sponsorships goes directly back
              into improving our community offerings, securing better venues, bringing in top-tier
              speakers, and expanding our reach across Switzerland.
            </p>
            <p className="text-lg text-gray-700">
              This commitment ensures that ZurichJS remains accessible, community-focused, and
              dedicated to advancing JavaScript education and networking opportunities for
      ...
      <Section variant="black">
        ...
        >
          ...
          <p className="text-xl max-w-3xl mx-auto">
            Our JavaScript community continues to grow and thrive thanks to amazing members like
            you!
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            >
              <div className="text-blue-800 mx-auto mb-4">{stat.icon}</div>
      ...
      <Section variant="black">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          ...
          >
            ...
            <div className="text-2xl md:text-3xl font-bold mb-1">
              {eventStats.growthRate > 0 ? "+" : ""}
              {eventStats.growthRate}%
            </div>
          ...
          >
            ...
            <div className="text-2xl md:text-3xl font-bold mb-1">
              {eventStats.attendanceGrowth > 0 ? "+" : ""}
              {eventStats.attendanceGrowth}
            </div>
        ...
        >
          ...
          <div className="mt-6 text-center text-gray-400">
            {eventStats.highestAttendanceEvent && (
              <p className="mb-2">
                Our biggest event so far was{" "}
                <strong className="text-blue-400">{eventStats.highestAttendanceEvent}</strong> with{" "}
                {eventStats.highestAttendance} attendees!
              </p>
            )}
            <p className="mb-4">
              As our community grows, so does our impact on the JavaScript ecosystem in Zurich!
            </p>
            ...
            {showMetricsExplanation && (
              ...
              >
                <h4 className="font-semibold text-gray-300 mb-2">
                  Understanding Our Growth Metrics
                </h4>
                <ul className="list-disc pl-5 space-y-2 text-left">
                  <li>
                    <span className="text-blue-400 font-medium">Attendance Growth:</span> Shows the
                    percentage increase in attendees from our first meetup to our most recent one (
                    {eventStats.growthRate}%).
                  </li>
                  <li>
                    <span className="text-blue-400 font-medium">New Attendees:</span> Represents the
                    additional number of people who have joined our meetups since we began (
                    {eventStats.attendanceGrowth} people).
                  </li>
                  <li>
                    <span className="text-blue-400 font-medium">Average Attendees:</span> The mean
                    number of participants across all our events ({eventStats.averageAttendees}{" "}
                    people per meetup).
                  </li>
                </ul>
                <p className="mt-3 italic">
                  These statistics help us track our community&apos;s expansion and engagement over
                  time.
                </p>
              </motion.div>
            )}
      ...
      <Section variant="white">
        ...
        >
          <h2 className="text-3xl font-bold mb-3 text-gray-900">
            Meet the JS Enthusiasts Behind the Magic ✨
          </h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
      ...
      <Section variant="gradient">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <h3 className="text-xl font-bold mb-3 border-b border-blue-700 pb-2 text-gray-900">
              Inclusivity & Respect 🤝
            </h3>
            <p className="text-gray-700">
              ZurichJS welcomes everyone, regardless of experience level, background, or coding
              style! We believe in creating a safe, respectful space where all JavaScript
              enthusiasts feel valued and heard.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              We&apos;re passionate about continuous learning! From beginners to experts, everyone
              has something to learn and something to teach. We embrace new ideas and technologies
              with open arms.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              The magic happens when we work together! We encourage collaboration, mentorship, and
              supporting each other&apos;s growth in the JavaScript ecosystem.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-700">
              JavaScript should be fun! We celebrate creative solutions, quirky approaches, and the
              joy of coding. Our meetups combine learning with fun social interactions.
            </p>
          </motion.div>
        </div>
      </Section>
      ...
      <Section variant="white">
        ...
        >
          <h2 className="text-3xl font-bold mb-4 text-blue-400">
            Ready to Join the JS Revolution? 🚀🧑‍💻
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Become part of our vibrant JavaScript community and connect with fellow developers in
            Zurich!
          </p>
      ...
      milestones: [
        {
          ...
          description:
            "Our first meetup brought together 34 developers at novu! We seized the opportunity to redefine what a JavaScript community could be in the Zurich area. We were honored to have Nico Martin, a renowned AI Google Developer Expert, as our inaugural speaker.",
        ...
        },
        {
          ...
          description:
            "We reached 100 followers on LinkedIn while our Meetup group flourished to 80-90 active members. The momentum was building!",
        ...
        },
        {
          ...
          description:
            "For our second meetup, we welcomed Evangelia who flew in specially from Thessaloniki, Greece. This month also marked the beginning of our valuable partnership with Web Zurich!",
        ...
        },
        {
          ...
          description:
            "We expanded into the international conference scene, establishing partnerships with React Paris and Code Blossom, complementing our existing collaborations with CityJS and Grusp.",
        ...
        },
        {
          ...
          description:
            "We proudly merged with the Vue Zurich meetup, welcoming their community into ours. We celebrated with Adam Berecz, a distinguished Vue.js expert from Hungary and founder of Vueform, as our featured speaker.",
        ...
        },
        {
          ...
          description:
            "Smallpdf graciously hosted our 4th meetup, joining our roster of generous venue partners alongside Ginetta, novu ag, and GetYourGuide in Zurich.",
        ...
        },
        {
          ...
          description:
            "We heard from local JS Jedi Masters about the way of a founder and dove deep on performance testing.",
        ...
        },
        {
          ...
          description:
            "This meetup and the workshop were all about server side JavaScript and Node.js.",
        ...
        },
        {
          ...
          description:
            "Astro and PHP plus our friends from Belgium joined us for an exciting summer meetup and brought some merch in their bags.",
        ...
        },
        {
          ...
          description:
            "Cloudflare joined us to share insights on optimizing web performance and security.",
        ...
        },
        {
          ...
          description:
            "Our spooky October meetup focused on identifying and fixing performance gaps and bugs in web applications with the support of Dynatrace, just in time for Halloween!",
        ...
        },
        {
          ...
          description:
            "We celebrated our first anniversary with a special meetup back where it all started at Pause im Foifi presented by Digitec/Galaxus!",
        ...
        },
        {
          ...
          title: "Vue x Stripe!",
          description:
            "We partnered with Stripe and Get Your Guide to bring an exciting Vue.js focused meetup to our community!",
          image: "/images/community/vue-zurich.jpeg",
        },
        /*        {
          id: '2026-01-22',
