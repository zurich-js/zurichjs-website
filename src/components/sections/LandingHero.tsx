                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 mt-6">
                        ...
                        <div className="flex gap-3">
                            <motion.a
                                href="https://join.slack.com/t/zurichjs/shared_invite/zt-27ewuu48a-0qJL8qGXO~wG7pO92ThGqw"
                                target="_blank"
                                rel="noopener noreferrer"
                                whileHover={{ y: -3, scale: 1.05 }}
                                className="flex items-center justify-center gap-1.5 text-sm bg-[#4A154B] text-white px-2.5 py-1.5 rounded-md hover:bg-[#611f64] transition-colors flex-1 sm:flex-none"
                            ...
                            >
                                <svg width="16" height="16" viewBox="0 0 54 54" xmlns="http://www.w3.org/2000/svg">
                                    <g fill="none" fillRule="evenodd">
                                        ...
                                        <path d="M0 34.249a5.381 5.381 0 0 0 5.376 5.386 5.381 5.381 0 0 0 5.376-5.386v-5.387H5.376A5.381 5.381 0 0 0 0 34.25m14.336-.001v14.364A5.381 5.381 0 0 0 19.712 54a5.381 5.381 0 0 0 5.376-5.387V34.25a5.381 5.381 0 0 0-5.376-5.387 5.381 5.381 0 0 0-5.376 5.387" fill="#ECB22E"/>
                                    </g>
                                </svg>
