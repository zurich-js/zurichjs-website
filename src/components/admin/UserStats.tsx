      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          ...
          <div className="mt-2 text-xs text-purple-700">
            {stats.totalUsers > 0 ? (
              <span>
                {Math.round((stats.surveyStats.totalSubmitted / stats.totalUsers) * 100)}% of users
              </span>
            ) : (
        ...
        <div className="bg-yellow-50 rounded-lg p-4">
          ...
          <div className="mt-2 text-xs text-yellow-700">
            {stats.surveyStats.totalSubmitted > 0 ? (
              <span>
                {Math.round(
                  (stats.surveyStats.newsletterSubscribers / stats.surveyStats.totalSubmitted) *
                    100,
                )}
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {stats.surveyStats.topInterests.map((interest) => (
            <div key={interest.name} className="bg-gray-100 rounded-full px-3 py-1 text-xs">
